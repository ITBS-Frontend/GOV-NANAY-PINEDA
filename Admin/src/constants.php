...
// Product version
define(PROJECT_NAMESPACE . "PRODUCT_VERSION", "24.15.0");

// Project
define(PROJECT_NAMESPACE . "PROJECT_NAME", "Gov_Nanay_Pineda"); // Project name
define(PROJECT_NAMESPACE . "PROJECT_ID", "{05BA416D-6E12-4581-9EFA-04B8838F18C5}"); // Project ID
