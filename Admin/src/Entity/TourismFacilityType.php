...
/**
 * Entity class for "tourism_facility_types" table
 */
#[Entity]
#[Table(name: "tourism_facility_types")]
class TourismFacilityType extends AbstractEntity
{
    #[Id]
    #[Column(type: "integer", unique: true)]
    #[GeneratedValue(strategy: "SEQUENCE")]
    #[SequenceGenerator(sequenceName: "tourism_facility_types_id_seq")]
    private int $id;
