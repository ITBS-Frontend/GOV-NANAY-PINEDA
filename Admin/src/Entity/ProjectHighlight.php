...
/**
 * Entity class for "project_highlights" table
 */
#[Entity]
#[Table(name: "project_highlights")]
class ProjectHighlight extends AbstractEntity
{
    #[Id]
    #[Column(type: "integer", unique: true)]
    #[GeneratedValue(strategy: "SEQUENCE")]
    #[SequenceGenerator(sequenceName: "project_highlights_id_seq")]
    private int $id;
    ...
    {
        return HtmlDecode($this->highlightText);
    }

    public function setHighlightText(string $value): static
    {
        $this->highlightText = RemoveXss($value);
        return $this;
    }
