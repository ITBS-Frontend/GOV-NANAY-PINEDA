...
/**
 * Entity class for "demographics_types" table
 */
#[Entity]
#[Table(name: "demographics_types")]
class DemographicsType extends AbstractEntity
{
    #[Id]
    #[Column(type: "integer", unique: true)]
    #[GeneratedValue(strategy: "SEQUENCE")]
    #[SequenceGenerator(sequenceName: "demographics_types_id_seq")]
    private int $id;
