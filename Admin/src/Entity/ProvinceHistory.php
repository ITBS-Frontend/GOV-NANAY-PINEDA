...
/**
 * Entity class for "province_history" table
 */
#[Entity]
#[Table(name: "province_history")]
class ProvinceHistory extends AbstractEntity
{
    #[Id]
    #[Column(type: "integer", unique: true)]
    #[GeneratedValue(strategy: "SEQUENCE")]
    #[SequenceGenerator(sequenceName: "province_history_id_seq")]
    private int $id;
    ...
    #[Column(name: "timeline_year", type: "integer", nullable: true)]
    private ?int $timelineYear;
    ...
    {
        return HtmlDecode($this->period);
    }

    public function setPeriod(?string $value): static
    {
        $this->period = RemoveXss($value);
        return $this;
    }
    ...
    public function getTimelineYear(): ?int
    {
        return $this->timelineYear;
    }

    public function setTimelineYear(?int $value): static
    {
        $this->timelineYear = $value;
        return $this;
    }
