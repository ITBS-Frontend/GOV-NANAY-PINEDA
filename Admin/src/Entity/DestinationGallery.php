...
/**
 * Entity class for "destination_gallery" table
 */
#[Entity]
#[Table(name: "destination_gallery")]
class DestinationGallery extends AbstractEntity
{
    #[Id]
    #[Column(type: "integer", unique: true)]
    #[GeneratedValue(strategy: "SEQUENCE")]
    #[SequenceGenerator(sequenceName: "destination_gallery_id_seq")]
    private int $id;
