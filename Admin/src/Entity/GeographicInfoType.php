...
/**
 * Entity class for "geographic_info_types" table
 */
#[Entity]
#[Table(name: "geographic_info_types")]
class GeographicInfoType extends AbstractEntity
{
    #[Id]
    #[Column(type: "integer", unique: true)]
    #[GeneratedValue(strategy: "SEQUENCE")]
    #[SequenceGenerator(sequenceName: "geographic_info_types_id_seq")]
    private int $id;
