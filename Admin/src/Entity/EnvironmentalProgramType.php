...
/**
 * Entity class for "environmental_program_types" table
 */
#[Entity]
#[Table(name: "environmental_program_types")]
class EnvironmentalProgramType extends AbstractEntity
{
    #[Id]
    #[Column(type: "integer", unique: true)]
    #[GeneratedValue(strategy: "SEQUENCE")]
    #[SequenceGenerator(sequenceName: "environmental_program_types_id_seq")]
    private int $id;
