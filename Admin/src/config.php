...
$CONFIG = [
    ...
    "PROJECT_STYLESHEET_FILENAME" => "css/Gov_Nanay_Pineda.css", // Project stylesheet file name
    ...
    "AES_ENCRYPTION_KEY" => "CTLOqYPcCwOMz1Ogq9EaiIgmSZIa47Rf1EKUXWI6N+c=", // AES encryption key (base64 encoded)
    ...
    "AUTH_CONFIG" => [
        "providers" => [
            ...
            "Azure" => [
                "enabled" => false,
                "adapter" => 'PHPMaker2024\\Gov_Nanay_Pineda\\AzureAD',
                "keys" => [
                    "id" => '',
            ...
            "Saml" => [
                "enabled" => false,
                "adapter" => 'PHPMaker2024\\Gov_Nanay_Pineda\\Saml2',
    ...
    // Export Log
    "EXPORT_PATH" => "export-05ba416d-6e12-4581-9efa-04b8838f18c5", // Export folder
    ...
    "USER_LEVEL_PRIV_TABLE" => "user_permissions",
    ...
    "USER_LEVEL_FIELD_NAME" => "user_level_id",
