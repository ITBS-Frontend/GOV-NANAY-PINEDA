...
<script>
loadjs.ready(["fpolitical_journeyedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fpolitical_journeyedit", "x_created_at", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
