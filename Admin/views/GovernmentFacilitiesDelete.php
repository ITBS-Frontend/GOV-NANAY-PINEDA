...
// Page object
$GovernmentFacilitiesDelete = &$Page;
?>
<script>
...
var currentForm;
var fgovernment_facilitiesdelete;
loadjs.ready(["wrapper", "head"], function () {
    ...
    let form = new ew.FormBuilder()
        .setId("fgovernment_facilitiesdelete")
        .setPageId("delete")
        .build();
    window[form.id] = form;
    currentForm = form;
...
$Page->showMessage();
?>
<form name="fgovernment_facilitiesdelete" id="fgovernment_facilitiesdelete" class="ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
...
<?php if ($Page->municipality->Visible) { // municipality ?>
        <th class="<?= $Page->municipality->headerCellClass() ?>"><span id="elh_government_facilities_municipality" class="government_facilities_municipality"><?= $Page->municipality->caption() ?></span></th>
<?php } ?>
<?php if ($Page->contact_number->Visible) { // contact_number ?>
        <th class="<?= $Page->contact_number->headerCellClass() ?>"><span id="elh_government_facilities_contact_number" class="government_facilities_contact_number"><?= $Page->contact_number->caption() ?></span></th>
<?php } ?>
<?php if ($Page->_email->Visible) { // email ?>
        <th class="<?= $Page->_email->headerCellClass() ?>"><span id="elh_government_facilities__email" class="government_facilities__email"><?= $Page->_email->caption() ?></span></th>
<?php } ?>
<?php if ($Page->operating_hours->Visible) { // operating_hours ?>
        <th class="<?= $Page->operating_hours->headerCellClass() ?>"><span id="elh_government_facilities_operating_hours" class="government_facilities_operating_hours"><?= $Page->operating_hours->caption() ?></span></th>
<?php } ?>
<?php if ($Page->coordinates->Visible) { // coordinates ?>
        <th class="<?= $Page->coordinates->headerCellClass() ?>"><span id="elh_government_facilities_coordinates" class="government_facilities_coordinates"><?= $Page->coordinates->caption() ?></span></th>
<?php } ?>
<?php if ($Page->featured_image->Visible) { // featured_image ?>
        <th class="<?= $Page->featured_image->headerCellClass() ?>"><span id="elh_government_facilities_featured_image" class="government_facilities_featured_image"><?= $Page->featured_image->caption() ?></span></th>
<?php } ?>
<?php if ($Page->is_active->Visible) { // is_active ?>
        <th class="<?= $Page->is_active->headerCellClass() ?>"><span id="elh_government_facilities_is_active" class="government_facilities_is_active"><?= $Page->is_active->caption() ?></span></th>
<?php } ?>
