...
$Page->showMessage();
?>
<form name="fgeographic_infodelete" id="fgeographic_infodelete" class="ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
...
<?php if ($Page->coordinates->Visible) { // coordinates ?>
        <th class="<?= $Page->coordinates->headerCellClass() ?>"><span id="elh_geographic_info_coordinates" class="geographic_info_coordinates"><?= $Page->coordinates->caption() ?></span></th>
<?php } ?>
<?php if ($Page->area_sqkm->Visible) { // area_sqkm ?>
        <th class="<?= $Page->area_sqkm->headerCellClass() ?>"><span id="elh_geographic_info_area_sqkm" class="geographic_info_area_sqkm"><?= $Page->area_sqkm->caption() ?></span></th>
<?php } ?>
<?php if ($Page->population->Visible) { // population ?>
        <th class="<?= $Page->population->headerCellClass() ?>"><span id="elh_geographic_info_population" class="geographic_info_population"><?= $Page->population->caption() ?></span></th>
<?php } ?>
