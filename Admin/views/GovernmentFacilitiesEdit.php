...
<script>
loadjs.ready(["fgovernment_facilitiesedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fgovernment_facilitiesedit", "x_created_at", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
