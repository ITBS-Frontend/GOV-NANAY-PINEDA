...
$sideMenu->addMenuItem(3, "mi_project_stats", $Language->menuPhrase("3", "MenuText"), "ProjectStatsList", -1, "", AllowListMenu('{05BA416D-6E12-4581-9EFA-04B8838F18C5}project_stats'), false, false, "", "", false, true);
...
$sideMenu->addMenuItem(8, "mi_main", $Language->menuPhrase("8", "MenuText"), "Main", -1, "", AllowListMenu('{05BA416D-6E12-4581-9EFA-04B8838F18C5}main.php'), false, false, "", "", false, true);
