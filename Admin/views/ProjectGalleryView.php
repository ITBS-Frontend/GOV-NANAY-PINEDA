...
?>
<main class="view">
<form name="fproject_galleryview" id="fproject_galleryview" class="ew-form ew-view-form overlay-wrapper" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
<?php if (!$Page->isExport()) { ?>
<script>
...
<?php if ($Page->id->Visible) { // id ?>
    <tr id="r_id"<?= $Page->id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_project_gallery_id"><?= $Page->id->caption() ?></span></td>
...
<?php if ($Page->project_id->Visible) { // project_id ?>
    <tr id="r_project_id"<?= $Page->project_id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_project_gallery_project_id"><?= $Page->project_id->caption() ?></span></td>
...
<?php if ($Page->image_path->Visible) { // image_path ?>
    <tr id="r_image_path"<?= $Page->image_path->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_project_gallery_image_path"><?= $Page->image_path->caption() ?></span></td>
...
<?php if ($Page->caption->Visible) { // caption ?>
    <tr id="r_caption"<?= $Page->caption->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_project_gallery_caption"><?= $Page->caption->caption() ?></span></td>
...
<?php if ($Page->display_order->Visible) { // display_order ?>
    <tr id="r_display_order"<?= $Page->display_order->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_project_gallery_display_order"><?= $Page->display_order->caption() ?></span></td>
...
<?php if ($Page->created_at->Visible) { // created_at ?>
    <tr id="r_created_at"<?= $Page->created_at->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_project_gallery_created_at"><?= $Page->created_at->caption() ?></span></td>
