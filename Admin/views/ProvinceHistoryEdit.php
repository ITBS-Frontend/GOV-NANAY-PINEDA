...
<script>
loadjs.ready(["fprovince_historyedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fprovince_historyedit", "x_created_at", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
