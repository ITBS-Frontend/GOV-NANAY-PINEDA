...
<script>
loadjs.ready(["fmunicipalitiesedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fmunicipalitiesedit", "x_created_at", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
