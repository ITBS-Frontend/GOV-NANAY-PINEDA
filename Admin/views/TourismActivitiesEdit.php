...
<script>
loadjs.ready(["ftourism_activitiesedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("ftourism_activitiesedit", "x_created_at", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
