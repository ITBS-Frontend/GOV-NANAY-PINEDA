...
<script>
loadjs.ready(["fdisaster_preparednessadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fdisaster_preparednessadd", "x_created_at", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
