...
<?php if ($Page->facility_type_id->Visible) { // facility_type_id ?>
        <th class="<?= $Page->facility_type_id->headerCellClass() ?>"><span id="elh_emergency_facilities_facility_type_id" class="emergency_facilities_facility_type_id"><?= $Page->facility_type_id->caption() ?></span></th>
<?php } ?>
    </tr>
    </thead>
    <tbody>
