...
<?php if ($Page->category_type_id->Visible) { // category_type_id ?>
        <th class="<?= $Page->category_type_id->headerCellClass() ?>"><span id="elh_categories_category_type_id" class="categories_category_type_id"><?= $Page->category_type_id->caption() ?></span></th>
<?php } ?>
    </tr>
    </thead>
    <tbody>
...
<?php } ?>
<?php if ($Page->category_type_id->Visible) { // category_type_id ?>
        <td<?= $Page->category_type_id->cellAttributes() ?>>
<span id="">
