...
<script>
loadjs.ready(["femergency_facilitiesedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("femergency_facilitiesedit", "x_created_at", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
