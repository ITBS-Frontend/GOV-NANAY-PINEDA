...
loadjs.ready(["fprojectsedit", "editor"], function() {
    ew.createEditor("fprojectsedit", "x_full_description", 35, 4, <?= $Page->full_description->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span>
</div></div>
...
<?php
    if (in_array("project_highlights", explode(",", $Page->getCurrentDetailTable())) && $project_highlights->DetailEdit) {
?>
...
<?php } ?>
<?php
    if (in_array("project_gallery", explode(",", $Page->getCurrentDetailTable())) && $project_gallery->DetailEdit) {
?>
<?php if ($Page->getCurrentDetailTable() != "") { ?>
