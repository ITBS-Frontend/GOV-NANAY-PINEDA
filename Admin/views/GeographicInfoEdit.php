...
<script>
loadjs.ready(["fgeographic_infoedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fgeographic_infoedit", "x_created_at", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
