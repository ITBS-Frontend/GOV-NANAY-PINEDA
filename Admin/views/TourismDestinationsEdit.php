...
<script>
loadjs.ready(["ftourism_destinationsedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("ftourism_destinationsedit", "x_created_at", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
