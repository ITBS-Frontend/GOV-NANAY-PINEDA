...
$Page->showMessage();
?>
<form name="fhealth_programsdelete" id="fhealth_programsdelete" class="ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
...
<?php if ($Page->id->Visible) { // id ?>
        <th class="<?= $Page->id->headerCellClass() ?>"><span id="elh_health_programs_id" class="health_programs_id"><?= $Page->id->caption() ?></span></th>
<?php } ?>
<?php if ($Page->program_name->Visible) { // program_name ?>
        <th class="<?= $Page->program_name->headerCellClass() ?>"><span id="elh_health_programs_program_name" class="health_programs_program_name"><?= $Page->program_name->caption() ?></span></th>
<?php } ?>
<?php if ($Page->target_beneficiaries->Visible) { // target_beneficiaries ?>
        <th class="<?= $Page->target_beneficiaries->headerCellClass() ?>"><span id="elh_health_programs_target_beneficiaries" class="health_programs_target_beneficiaries"><?= $Page->target_beneficiaries->caption() ?></span></th>
<?php } ?>
<?php if ($Page->coverage_area->Visible) { // coverage_area ?>
        <th class="<?= $Page->coverage_area->headerCellClass() ?>"><span id="elh_health_programs_coverage_area" class="health_programs_coverage_area"><?= $Page->coverage_area->caption() ?></span></th>
<?php } ?>
...
<?php if ($Page->is_active->Visible) { // is_active ?>
        <th class="<?= $Page->is_active->headerCellClass() ?>"><span id="elh_health_programs_is_active" class="health_programs_is_active"><?= $Page->is_active->caption() ?></span></th>
<?php } ?>
...
<?php } ?>
<?php if ($Page->target_beneficiaries->Visible) { // target_beneficiaries ?>
        <td<?= $Page->target_beneficiaries->cellAttributes() ?>>
<span id="">
