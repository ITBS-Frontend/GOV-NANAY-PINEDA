...
<script>
loadjs.ready(["ftourism_categoriesadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("ftourism_categoriesadd", "x_created_at", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
