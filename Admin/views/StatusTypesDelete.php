...
<?php if ($Page->id->Visible) { // id ?>
        <th class="<?= $Page->id->headerCellClass() ?>"><span id="elh_status_types_id" class="status_types_id"><?= $Page->id->caption() ?></span></th>
<?php } ?>
<?php if ($Page->type_name->Visible) { // type_name ?>
        <th class="<?= $Page->type_name->headerCellClass() ?>"><span id="elh_status_types_type_name" class="status_types_type_name"><?= $Page->type_name->caption() ?></span></th>
<?php } ?>
...
<?php if ($Page->display_order->Visible) { // display_order ?>
        <th class="<?= $Page->display_order->headerCellClass() ?>"><span id="elh_status_types_display_order" class="status_types_display_order"><?= $Page->display_order->caption() ?></span></th>
<?php } ?>
<?php if ($Page->is_active->Visible) { // is_active ?>
        <th class="<?= $Page->is_active->headerCellClass() ?>"><span id="elh_status_types_is_active" class="status_types_is_active"><?= $Page->is_active->caption() ?></span></th>
<?php } ?>
<?php if ($Page->created_at->Visible) { // created_at ?>
        <th class="<?= $Page->created_at->headerCellClass() ?>"><span id="elh_status_types_created_at" class="status_types_created_at"><?= $Page->created_at->caption() ?></span></th>
<?php } ?>
    </tr>
    </thead>
    <tbody>
