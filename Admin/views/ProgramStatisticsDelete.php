...
loadjs.ready(["wrapper", "head"], function () {
    ...
    let form = new ew.FormBuilder()
        .setId("fprogram_statisticsdelete")
        .setPageId("delete")
        .build();
    window[form.id] = form;
    currentForm = form;
...
$Page->showMessage();
?>
<form name="fprogram_statisticsdelete" id="fprogram_statisticsdelete" class="ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
...
<?php if ($Page->id->Visible) { // id ?>
        <th class="<?= $Page->id->headerCellClass() ?>"><span id="elh_program_statistics_id" class="program_statistics_id"><?= $Page->id->caption() ?></span></th>
<?php } ?>
...
<?php if ($Page->stat_value->Visible) { // stat_value ?>
        <th class="<?= $Page->stat_value->headerCellClass() ?>"><span id="elh_program_statistics_stat_value" class="program_statistics_stat_value"><?= $Page->stat_value->caption() ?></span></th>
<?php } ?>
<?php if ($Page->year->Visible) { // year ?>
        <th class="<?= $Page->year->headerCellClass() ?>"><span id="elh_program_statistics_year" class="program_statistics_year"><?= $Page->year->caption() ?></span></th>
<?php } ?>
