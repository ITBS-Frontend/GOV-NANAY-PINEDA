...
<script>
loadjs.ready(["ftourism_facilitiesadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("ftourism_facilitiesadd", "x_created_at", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
