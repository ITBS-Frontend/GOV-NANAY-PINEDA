...
<script>
loadjs.ready(["fbusiness_sectorsadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fbusiness_sectorsadd", "x_created_at", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
