...
<script>
loadjs.ready(["fpublic_servicesedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fpublic_servicesedit", "x_created_at", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
