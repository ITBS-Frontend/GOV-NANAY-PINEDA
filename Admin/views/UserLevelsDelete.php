...
<?php if ($Page->user_level_name->Visible) { // user_level_name ?>
        <th class="<?= $Page->user_level_name->headerCellClass() ?>"><span id="elh__user_levels_user_level_name" class="_user_levels_user_level_name"><?= $Page->user_level_name->caption() ?></span></th>
<?php } ?>
<?php if ($Page->hierarchy->Visible) { // hierarchy ?>
        <th class="<?= $Page->hierarchy->headerCellClass() ?>"><span id="elh__user_levels_hierarchy" class="_user_levels_hierarchy"><?= $Page->hierarchy->caption() ?></span></th>
<?php } ?>
<?php if ($Page->created_at->Visible) { // created_at ?>
        <th class="<?= $Page->created_at->headerCellClass() ?>"><span id="elh__user_levels_created_at" class="_user_levels_created_at"><?= $Page->created_at->caption() ?></span></th>
<?php } ?>
<?php if ($Page->updated_at->Visible) { // updated_at ?>
        <th class="<?= $Page->updated_at->headerCellClass() ?>"><span id="elh__user_levels_updated_at" class="_user_levels_updated_at"><?= $Page->updated_at->caption() ?></span></th>
<?php } ?>
    </tr>
    </thead>
    <tbody>
