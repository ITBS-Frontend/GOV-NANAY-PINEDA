...
$Page->showMessage();
?>
<form name="fpampanga_aboutadd" id="fpampanga_aboutadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
...
<input type="hidden" name="fa_x_showcase_image_1" id= "fa_x_showcase_image_1" value="0">
...
<input type="hidden" name="fa_x_showcase_image_2" id= "fa_x_showcase_image_2" value="0">
...
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit" form="fpampanga_aboutadd"><?= $Language->phrase("AddBtn") ?></button>
<?php if (IsJsonResponse()) { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-bs-dismiss="modal"><?= $Language->phrase("CancelBtn") ?></button>
<?php } else { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" form="fpampanga_aboutadd" data-href="<?= HtmlEncode(GetUrl($Page->getReturnUrl())) ?>"><?= $Language->phrase("CancelBtn") ?></button>
<?php } ?>
    </div><!-- /buttons offset -->
