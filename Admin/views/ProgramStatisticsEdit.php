...
<script>
loadjs.ready(["fprogram_statisticsedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fprogram_statisticsedit", "x_created_at", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
