 ...
 * Page class
 */
class DisasterPreparednessDelete extends DisasterPreparedness
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DisasterPreparednessDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "DisasterPreparednessDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("DisasterPreparednessList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("DisasterPreparednessList"); // Return to list
                return;
            }
        }
