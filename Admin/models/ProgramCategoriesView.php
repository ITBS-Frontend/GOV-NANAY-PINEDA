 ...
 * Page class
 */
class ProgramCategoriesView extends ProgramCategories
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProgramCategoriesView";
    ...
    // CSS class/style
    public $CurrentPageName = "ProgramCategoriesView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "ProgramCategoriesList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ProgramCategoriesList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
