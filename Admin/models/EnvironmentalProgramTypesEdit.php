 ...
 * Page class
 */
class EnvironmentalProgramTypesEdit extends EnvironmentalProgramTypes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EnvironmentalProgramTypesEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "EnvironmentalProgramTypesEdit";
    ...
    protected function editRow()
    {
        ...
        // Check field with unique index (type_name)
        if ($this->type_name->CurrentValue != "") {
            $filterChk = "(\"type_name\" = '" . AdjustSql($this->type_name->CurrentValue, $this->Dbid) . "')";
    ...
    protected function restoreEditFormFromRow($row)
    {
        if (isset($row['type_name'])) { // type_name
            $this->type_name->CurrentValue = $row['type_name'];
        }
