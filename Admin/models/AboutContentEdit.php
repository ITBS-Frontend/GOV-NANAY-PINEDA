 ...
 * Page class
 */
class AboutContentEdit extends AboutContent
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AboutContentEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "AboutContentEdit";
    ...
    protected function getEditRow($rsold)
    {
        ...
        // section_type
        $this->section_type->setDbValueDef($rsnew, $this->section_type->CurrentValue, $this->section_type->ReadOnly);
    ...
    protected function restoreEditFormFromRow($row)
    {
        if (isset($row['section_type'])) { // section_type
            $this->section_type->CurrentValue = $row['section_type'];
        }
