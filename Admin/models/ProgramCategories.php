...
/**
 * Table class for program_categories
 */
class ProgramCategories extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "program_categories";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "program_categories";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ProgramCategoriesList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "ProgramCategoriesView" => $Language->phrase("View"),
            "ProgramCategoriesEdit" => $Language->phrase("Edit"),
            "ProgramCategoriesAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ProgramCategoriesView",
            Config("API_ADD_ACTION") => "ProgramCategoriesAdd",
            Config("API_EDIT_ACTION") => "ProgramCategoriesEdit",
            Config("API_DELETE_ACTION") => "ProgramCategoriesDelete",
            Config("API_LIST_ACTION") => "ProgramCategoriesList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ProgramCategoriesView", $parm);
        } else {
            $url = $this->keyUrl("ProgramCategoriesView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "ProgramCategoriesAdd?" . $parm;
        } else {
            $url = "ProgramCategoriesAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ProgramCategoriesEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ProgramCategoriesList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ProgramCategoriesAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ProgramCategoriesList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ProgramCategoriesDelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "ProgramCategoriesList";
