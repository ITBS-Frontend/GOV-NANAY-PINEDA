 ...
 * Page class
 */
class OwnershipTypesDelete extends OwnershipTypes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "OwnershipTypesDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "OwnershipTypesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("OwnershipTypesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("OwnershipTypesList"); // Return to list
                return;
            }
        }
