...
/**
 * Table class for project_highlights
 */
class ProjectHighlights extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "project_highlights";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // highlight_text
        $this->highlight_text = new DbField(
            $this, // Table
            'x_highlight_text', // Variable name
            'highlight_text', // Name
            '"highlight_text"', // Expression
            '"highlight_text"', // Basic search expression
            201, // Type
            0, // Size
            -1, // Date/Time format
            false, // Is upload field
            '"highlight_text"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->highlight_text->InputTextType = "text";
        $this->highlight_text->Nullable = false; // NOT NULL field
        $this->highlight_text->Required = true; // Required field
        $this->highlight_text->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
        $this->Fields['highlight_text'] = &$this->highlight_text;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "project_highlights";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->highlight_text->DbValue = $row['highlight_text'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ProjectHighlightsList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "ProjectHighlightsView" => $Language->phrase("View"),
            "ProjectHighlightsEdit" => $Language->phrase("Edit"),
            "ProjectHighlightsAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ProjectHighlightsView",
            Config("API_ADD_ACTION") => "ProjectHighlightsAdd",
            Config("API_EDIT_ACTION") => "ProjectHighlightsEdit",
            Config("API_DELETE_ACTION") => "ProjectHighlightsDelete",
            Config("API_LIST_ACTION") => "ProjectHighlightsList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ProjectHighlightsView", $parm);
        } else {
            $url = $this->keyUrl("ProjectHighlightsView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "ProjectHighlightsAdd?" . $parm;
        } else {
            $url = "ProjectHighlightsAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ProjectHighlightsEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ProjectHighlightsList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ProjectHighlightsAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ProjectHighlightsList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ProjectHighlightsDelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "ProjectHighlightsList";
    ...
    public function renderListRow()
    {
        ...
        // highlight_text
        $this->highlight_text->HrefValue = "";
        $this->highlight_text->TooltipValue = "";
    ...
    public function renderEditRow()
    {
        ...
        $this->highlight_text->EditValue = $this->highlight_text->CurrentValue;
        $this->highlight_text->PlaceHolder = RemoveHtml($this->highlight_text->caption());
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->highlight_text);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->highlight_text);
