 ...
 * Page class
 */
class ServiceCategoriesView extends ServiceCategories
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ServiceCategoriesView";
    ...
    // CSS class/style
    public $CurrentPageName = "ServiceCategoriesView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "ServiceCategoriesList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ServiceCategoriesList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
