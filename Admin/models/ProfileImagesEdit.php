 ...
 * Page class
 */
class ProfileImagesEdit extends ProfileImages
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProfileImagesEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "ProfileImagesEdit";
    ...
    protected function getEditRow($rsold)
    {
        ...
        $this->is_primary->setDbValueDef($rsnew, $tmpBool, $this->is_primary->ReadOnly);
    ...
    protected function restoreEditFormFromRow($row)
    {
        ...
        if (isset($row['image_type'])) { // image_type
            $this->image_type->CurrentValue = $row['image_type'];
        }
        if (isset($row['is_primary'])) { // is_primary
            $this->is_primary->CurrentValue = $row['is_primary'];
        }
