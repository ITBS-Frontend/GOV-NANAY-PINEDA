 ...
 * Page class
 */
class EmergencyFacilitiesDelete extends EmergencyFacilities
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmergencyFacilitiesDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "EmergencyFacilitiesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("EmergencyFacilitiesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("EmergencyFacilitiesList"); // Return to list
                return;
            }
        }
