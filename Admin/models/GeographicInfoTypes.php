...
/**
 * Table class for geographic_info_types
 */
class GeographicInfoTypes extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "geographic_info_types";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->is_active->Lookup = new Lookup($this->is_active, 'geographic_info_types', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "geographic_info_types";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("GeographicInfoTypesList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "GeographicInfoTypesView" => $Language->phrase("View"),
            "GeographicInfoTypesEdit" => $Language->phrase("Edit"),
            "GeographicInfoTypesAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    {
        return "GeographicInfoTypesList";
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "GeographicInfoTypesView",
            Config("API_ADD_ACTION") => "GeographicInfoTypesAdd",
            Config("API_EDIT_ACTION") => "GeographicInfoTypesEdit",
            Config("API_DELETE_ACTION") => "GeographicInfoTypesDelete",
            Config("API_LIST_ACTION") => "GeographicInfoTypesList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("GeographicInfoTypesView", $parm);
        } else {
            $url = $this->keyUrl("GeographicInfoTypesView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "GeographicInfoTypesAdd?" . $parm;
        } else {
            $url = "GeographicInfoTypesAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("GeographicInfoTypesEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("GeographicInfoTypesList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("GeographicInfoTypesAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("GeographicInfoTypesList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("GeographicInfoTypesDelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "GeographicInfoTypesList";
