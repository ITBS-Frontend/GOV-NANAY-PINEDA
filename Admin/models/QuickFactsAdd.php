 ...
 * Page class
 */
class QuickFactsAdd extends QuickFacts
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "QuickFactsAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "QuickFactsAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("QuickFactsList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "QuickFactsList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "QuickFactsView") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "QuickFactsList") {
                            ...
                            $returnUrl = "QuickFactsList"; // Return list page content
                        }
                    }
    ...
    protected function validateForm()
    {
        ...
        $validateForm = true;
            if ($this->icon->Visible && $this->icon->Required) {
    ...
    protected function getAddRow()
    {
        ...
        // display_order
        $this->display_order->setDbValueDef($rsnew, $this->display_order->CurrentValue, false);
    ...
    {
        if (isset($row['icon'])) { // icon
            $this->icon->setFormValue($row['icon']);
        }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("QuickFactsList"), "", $this->TableVar, true);
