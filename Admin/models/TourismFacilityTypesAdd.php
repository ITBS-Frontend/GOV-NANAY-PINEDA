 ...
 * Page class
 */
class TourismFacilityTypesAdd extends TourismFacilityTypes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TourismFacilityTypesAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "TourismFacilityTypesAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "TourismFacilityTypesView") {
