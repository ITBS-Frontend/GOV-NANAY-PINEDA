 ...
 * Page class
 */
class ProjectsDelete extends Projects
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProjectsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ProjectsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ProjectsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ProjectsList"); // Return to list
                return;
            }
        }
