 ...
 * Page class
 */
class ServiceCategoriesDelete extends ServiceCategories
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ServiceCategoriesDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ServiceCategoriesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ServiceCategoriesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ServiceCategoriesList"); // Return to list
                return;
            }
        }
