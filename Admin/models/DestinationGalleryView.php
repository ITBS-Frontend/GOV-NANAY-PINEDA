 ...
 * Page class
 */
class DestinationGalleryView extends DestinationGallery
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DestinationGalleryView";
    ...
    // CSS class/style
    public $CurrentPageName = "DestinationGalleryView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "DestinationGalleryList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "DestinationGalleryList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
