 ...
 * Page class
 */
class DestinationGalleryAdd extends DestinationGallery
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DestinationGalleryAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "DestinationGalleryAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("DestinationGalleryList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "DestinationGalleryView") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions && !$this->getCurrentMasterTable()) {
                        ...
                        if (GetPageName($returnUrl) != "DestinationGalleryList") {
                            ...
                            $returnUrl = "DestinationGalleryList"; // Return list page content
                        }
                    }
