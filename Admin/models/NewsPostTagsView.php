 ...
 * Page class
 */
class NewsPostTagsView extends NewsPostTags
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NewsPostTagsView";
    ...
    // CSS class/style
    public $CurrentPageName = "NewsPostTagsView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("post_id") ?? Route("post_id")) !== null) {
            $this->RecKey["post_id"] = $keyValue;
        }
        if (($keyValue = Get("tag_id") ?? Route("tag_id")) !== null) {
            $this->RecKey["tag_id"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("post_id") ?? Route("post_id")) !== null) {
            ...
            $this->RecKey["post_id"] = $this->post_id->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->post_id->setQueryStringValue($keyValue);
            $this->RecKey["post_id"] = $this->post_id->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "NewsPostTagsList"; // Return to list
        }
        if (($keyValue = Get("tag_id") ?? Route("tag_id")) !== null) {
            $this->tag_id->setQueryStringValue($keyValue);
            $this->RecKey["tag_id"] = $this->tag_id->QueryStringValue;
        } elseif (Post("tag_id") !== null) {
            $this->tag_id->setFormValue(Post("tag_id"));
            $this->RecKey["tag_id"] = $this->tag_id->FormValue;
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "NewsPostTagsList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
