 ...
 * Page class
 */
class EconomicIndicatorsEdit extends EconomicIndicators
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EconomicIndicatorsEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "EconomicIndicatorsEdit";
    ...
    protected function getEditRow($rsold)
    {
        ...
        // indicator_name
        $this->indicator_name->setDbValueDef($rsnew, $this->indicator_name->CurrentValue, $this->indicator_name->ReadOnly);
        ...
        // quarter
        $this->quarter->setDbValueDef($rsnew, $this->quarter->CurrentValue, $this->quarter->ReadOnly);
    ...
    protected function restoreEditFormFromRow($row)
    {
        if (isset($row['indicator_name'])) { // indicator_name
            $this->indicator_name->CurrentValue = $row['indicator_name'];
        }
        ...
        if (isset($row['year'])) { // year
            $this->year->CurrentValue = $row['year'];
        }
        if (isset($row['quarter'])) { // quarter
            $this->quarter->CurrentValue = $row['quarter'];
        }
        if (isset($row['source'])) { // source
            $this->source->CurrentValue = $row['source'];
        }
