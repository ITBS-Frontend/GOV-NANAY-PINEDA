 ...
 * Page class
 */
class HealthProgramsEdit extends HealthPrograms
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "HealthProgramsEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "HealthProgramsEdit";
    ...
    protected function getEditRow($rsold)
    {
        ...
        // target_beneficiaries
        $this->target_beneficiaries->setDbValueDef($rsnew, $this->target_beneficiaries->CurrentValue, $this->target_beneficiaries->ReadOnly);
    ...
    protected function restoreEditFormFromRow($row)
    {
        ...
        if (isset($row['target_beneficiaries'])) { // target_beneficiaries
            $this->target_beneficiaries->CurrentValue = $row['target_beneficiaries'];
        }
