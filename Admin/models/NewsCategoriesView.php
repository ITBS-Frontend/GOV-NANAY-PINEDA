 ...
 * Page class
 */
class NewsCategoriesView extends NewsCategories
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NewsCategoriesView";
    ...
    // CSS class/style
    public $CurrentPageName = "NewsCategoriesView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "NewsCategoriesList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "NewsCategoriesList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
