 ...
 * Page class
 */
class DisasterTypesDelete extends DisasterTypes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DisasterTypesDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "DisasterTypesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("DisasterTypesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("DisasterTypesList"); // Return to list
                return;
            }
        }
