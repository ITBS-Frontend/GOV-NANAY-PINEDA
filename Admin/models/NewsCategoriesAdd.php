 ...
 * Page class
 */
class NewsCategoriesAdd extends NewsCategories
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NewsCategoriesAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "NewsCategoriesAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("NewsCategoriesList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "NewsCategoriesList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "NewsCategoriesView") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "NewsCategoriesList") {
                            ...
                            $returnUrl = "NewsCategoriesList"; // Return list page content
                        }
                    }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("NewsCategoriesList"), "", $this->TableVar, true);
