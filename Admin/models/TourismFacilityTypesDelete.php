 ...
 * Page class
 */
class TourismFacilityTypesDelete extends TourismFacilityTypes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TourismFacilityTypesDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "TourismFacilityTypesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("TourismFacilityTypesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("TourismFacilityTypesList"); // Return to list
                return;
            }
        }
