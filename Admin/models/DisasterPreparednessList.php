 ...
 * Page class
 */
class DisasterPreparednessList extends DisasterPreparedness
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DisasterPreparednessList";
    ...
    public $FormName = "fdisaster_preparednesslist";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "DisasterPreparednessList";
    ...
    public function setVisibility()
    {
        ...
        $this->relief_procedures->Visible = false;
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'disaster_preparedness';
        $this->TableName = 'disaster_preparedness';
        ...
        // Table object (disaster_preparedness)
        if (!isset($GLOBALS["disaster_preparedness"]) || $GLOBALS["disaster_preparedness"]::class == PROJECT_NAMESPACE . "disaster_preparedness") {
            $GLOBALS["disaster_preparedness"] = &$this;
        }
        ...
        // Initialize URLs
        $this->AddUrl = "DisasterPreparednessAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiEditUrl = $pageUrl . "action=multiedit";
        $this->MultiDeleteUrl = "DisasterPreparednessDelete";
        $this->MultiUpdateUrl = "DisasterPreparednessUpdate";

        // Table name (for backward compatibility only)
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'disaster_preparedness');
        }
        ...
        if ($url != "") {
            ...
            if ($this->IsModal) { // Show as modal
                ...
                if (!SameString($pageName, GetPageName($this->getListUrl()))) { // Not List page
                    ...
                    $result["view"] = SameString($pageName, "DisasterPreparednessView"); // If View page, no primary button
                } else { // List page
    ...
    public function run()
    {
        ...
        if ($this->IsModal) {
            $this->FormName = "fdisaster_preparednessgrid";
        }
    ...
    public function getFilterList()
    {
        ...
        $filterList = Concat($filterList, $this->relief_procedures->AdvancedSearch->toJson(), ","); // Field relief_procedures
    ...
    protected function processFilterList()
    {
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            Profile()->setSearchFilters("fdisaster_preparednesssrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        $this->preparedness_guide->AdvancedSearch->SearchOperator = @$filter["z_preparedness_guide"];
        $this->preparedness_guide->AdvancedSearch->SearchCondition = @$filter["v_preparedness_guide"];
        $this->preparedness_guide->AdvancedSearch->SearchValue2 = @$filter["y_preparedness_guide"];
        $this->preparedness_guide->AdvancedSearch->SearchOperator2 = @$filter["w_preparedness_guide"];
        $this->preparedness_guide->AdvancedSearch->save();

        // Field emergency_hotlines
        $this->emergency_hotlines->AdvancedSearch->SearchValue = @$filter["x_emergency_hotlines"];
        $this->emergency_hotlines->AdvancedSearch->SearchOperator = @$filter["z_emergency_hotlines"];
        $this->emergency_hotlines->AdvancedSearch->SearchCondition = @$filter["v_emergency_hotlines"];
        $this->emergency_hotlines->AdvancedSearch->SearchValue2 = @$filter["y_emergency_hotlines"];
        $this->emergency_hotlines->AdvancedSearch->SearchOperator2 = @$filter["w_emergency_hotlines"];
        $this->emergency_hotlines->AdvancedSearch->save();

        // Field evacuation_centers
        $this->evacuation_centers->AdvancedSearch->SearchValue = @$filter["x_evacuation_centers"];
        $this->evacuation_centers->AdvancedSearch->SearchOperator = @$filter["z_evacuation_centers"];
        $this->evacuation_centers->AdvancedSearch->SearchCondition = @$filter["v_evacuation_centers"];
        $this->evacuation_centers->AdvancedSearch->SearchValue2 = @$filter["y_evacuation_centers"];
        $this->evacuation_centers->AdvancedSearch->SearchOperator2 = @$filter["w_evacuation_centers"];
        $this->evacuation_centers->AdvancedSearch->save();

        // Field relief_procedures
        $this->relief_procedures->AdvancedSearch->SearchValue = @$filter["x_relief_procedures"];
        $this->relief_procedures->AdvancedSearch->SearchOperator = @$filter["z_relief_procedures"];
        $this->relief_procedures->AdvancedSearch->SearchCondition = @$filter["v_relief_procedures"];
        $this->relief_procedures->AdvancedSearch->SearchValue2 = @$filter["y_relief_procedures"];
        $this->relief_procedures->AdvancedSearch->SearchOperator2 = @$filter["w_relief_procedures"];
        $this->relief_procedures->AdvancedSearch->save();
    ...
    public function basicSearchWhere($default = false)
    {
        ...
        $searchFlds[] = &$this->relief_procedures;
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->relief_procedures->setSort("");
        ...
        if ($this->CurrentMode == "view") {
            ...
            if ($Security->canView()) {
                if ($this->ModalView && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-view\" title=\"" . $viewcaption . "\" data-table=\"disaster_preparedness\" data-caption=\"" . $viewcaption . "\" data-ew-action=\"modal\" data-action=\"view\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->ViewUrl)) . "\" data-btn=\"null\">" . $Language->phrase("ViewLink") . "</a>";
                } else {
            ...
            if ($Security->canEdit()) {
                if ($this->ModalEdit && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-edit\" title=\"" . $editcaption . "\" data-table=\"disaster_preparedness\" data-caption=\"" . $editcaption . "\" data-ew-action=\"modal\" data-action=\"edit\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->EditUrl)) . "\" data-btn=\"SaveBtn\">" . $Language->phrase("EditLink") . "</a>";
                } else {
            ...
            if ($Security->canAdd()) {
                if ($this->ModalAdd && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-copy\" title=\"" . $copycaption . "\" data-table=\"disaster_preparedness\" data-caption=\"" . $copycaption . "\" data-ew-action=\"modal\" data-action=\"add\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->CopyUrl)) . "\" data-btn=\"AddBtn\">" . $Language->phrase("CopyLink") . "</a>";
                } else {
                ...
                if ($listAction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    if ($action != "") {
                        ...
                        $link = $disabled
                            ...
                            : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fdisaster_preparednesslist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listAction->toDataAttributes() . ">" . $icon . " " . $caption . "</button></li>";
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = $disabled
                            ? "<div class=\"alert alert-light\">" . $icon . " " . $caption . "</div>"
                            : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . $title . "\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fdisaster_preparednesslist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listAction->toDataAttributes() . ">" . $icon . " " . $caption . "</button>";
                        }
                    }
                }
            }
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->ModalAdd && !IsMobile()) {
            $item->Body = "<a class=\"ew-add-edit ew-add\" title=\"" . $addcaption . "\" data-table=\"disaster_preparedness\" data-caption=\"" . $addcaption . "\" data-ew-action=\"modal\" data-action=\"add\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->AddUrl)) . "\" data-btn=\"AddBtn\">" . $Language->phrase("AddLink") . "</a>";
        } else {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fdisaster_preparednesssrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fdisaster_preparednesssrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions as $listAction) {
            if ($listAction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="fdisaster_preparednesslist"' . $listAction->toDataAttributes() . '>' . $icon . '</button>';
    ...
    public function setupRow()
    {
        ...
        if ($this->isGridAdd() || $this->isGridEdit()) {
            if ($this->RowIndex === '$rowindex$') { // Render template row first
                ...
                // Set row properties
                $this->resetAttributes();
                $this->RowAttrs->merge(["data-rowindex" => $this->RowIndex, "id" => "r0_disaster_preparedness", "data-rowtype" => RowType::ADD]);
        ...
        $this->RowAttrs->merge([
            ...
            "id" => "r" . $this->RowCount . "_disaster_preparedness",
    ...
    protected function newRow()
    {
        ...
        $row['relief_procedures'] = $this->relief_procedures->DefaultValue;
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fdisaster_preparednesssrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
