 ...
 * Page class
 */
class TourismFacilitiesAdd extends TourismFacilities
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TourismFacilitiesAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "TourismFacilitiesAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "TourismFacilitiesView") {
    ...
    protected function getAddRow()
    {
        ...
        // price_range
        $this->price_range->setDbValueDef($rsnew, $this->price_range->CurrentValue, false);

        // amenities
        $this->amenities->setDbValueDef($rsnew, $this->amenities->CurrentValue, false);
    ...
    protected function restoreAddFormFromRow($row)
    {
        ...
        if (isset($row['price_range'])) { // price_range
            $this->price_range->setFormValue($row['price_range']);
        }
        if (isset($row['amenities'])) { // amenities
            $this->amenities->setFormValue($row['amenities']);
        }
