 ...
 * Page class
 */
class ProgramStatisticsAdd extends ProgramStatistics
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProgramStatisticsAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "ProgramStatisticsAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("ProgramStatisticsList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "ProgramStatisticsList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "ProgramStatisticsView") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "ProgramStatisticsList") {
                            ...
                            $returnUrl = "ProgramStatisticsList"; // Return list page content
                        }
                    }
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->program_id->IsDetailKey) {
            if (IsApi() && $val === null) {
                ...
                $this->program_id->setFormValue($val, true, $validate);
            }
        }
    ...
    protected function validateForm()
    {
        ...
        $validateForm = true;
            if ($this->program_id->Visible && $this->program_id->Required) {
    ...
    protected function getAddRow()
    {
        ...
        // program_id
        $this->program_id->setDbValueDef($rsnew, $this->program_id->CurrentValue, false);
    ...
    protected function restoreAddFormFromRow($row)
    {
        if (isset($row['program_id'])) { // program_id
            $this->program_id->setFormValue($row['program_id']);
        }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("ProgramStatisticsList"), "", $this->TableVar, true);
