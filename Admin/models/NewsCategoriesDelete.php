 ...
 * Page class
 */
class NewsCategoriesDelete extends NewsCategories
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NewsCategoriesDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "NewsCategoriesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("NewsCategoriesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("NewsCategoriesList"); // Return to list
                return;
            }
        }
