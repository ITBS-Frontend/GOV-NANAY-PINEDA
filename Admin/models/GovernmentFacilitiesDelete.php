 ...
 * Page class
 */
class GovernmentFacilitiesDelete extends GovernmentFacilities
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "GovernmentFacilitiesDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "GovernmentFacilitiesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("GovernmentFacilitiesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("GovernmentFacilitiesList"); // Return to list
                return;
            }
        }
