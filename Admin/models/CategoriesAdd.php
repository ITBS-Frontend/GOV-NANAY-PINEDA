...
class CategoriesAdd extends Categories
{
    ...
    // CSS class/style
    public $CurrentPageName = "CategoriesAdd";
    ...
    protected function getAddRow()
    {
        ...
        // category_type_id
        $this->category_type_id->setDbValueDef($rsnew, $this->category_type_id->CurrentValue, false);
        return $rsnew;
    }
    ...
    protected function restoreAddFormFromRow($row)
    {
        ...
        if (isset($row['category_type_id'])) { // category_type_id
            $this->category_type_id->setFormValue($row['category_type_id']);
        }
    }
