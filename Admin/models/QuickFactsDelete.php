 ...
 * Page class
 */
class QuickFactsDelete extends QuickFacts
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "QuickFactsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "QuickFactsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("QuickFactsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("QuickFactsList"); // Return to list
                return;
            }
        }
