 ...
 * Page class
 */
class ProgramTypesView extends ProgramTypes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProgramTypesView";
    ...
    // CSS class/style
    public $CurrentPageName = "ProgramTypesView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "ProgramTypesList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ProgramTypesList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
