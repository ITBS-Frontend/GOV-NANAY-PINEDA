 ...
 * Page class
 */
class EmergencyFacilityTypesEdit extends EmergencyFacilityTypes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmergencyFacilityTypesEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "EmergencyFacilityTypesEdit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("EmergencyFacilityTypesList"); // No matching record, return to list
                        return;
                    }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "EmergencyFacilityTypesList") {
                ...
                if ($this->editRow()) { // Update record based on key
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "EmergencyFacilityTypesList") {
                            ...
                            $returnUrl = "EmergencyFacilityTypesList"; // Return list page content
                        }
                    }
                    if (IsJsonResponse()) {
                        $this->terminate(true);
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("EmergencyFacilityTypesList"), "", $this->TableVar, true);
        $pageId = "edit";
