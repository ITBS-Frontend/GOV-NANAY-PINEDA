 ...
 * Page class
 */
class TourismDestinationsEdit extends TourismDestinations
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TourismDestinationsEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "TourismDestinationsEdit";
    ...
    protected function getEditRow($rsold)
    {
        ...
        // entry_fee
        $this->entry_fee->setDbValueDef($rsnew, $this->entry_fee->CurrentValue, $this->entry_fee->ReadOnly);

        // operating_hours
        $this->operating_hours->setDbValueDef($rsnew, $this->operating_hours->CurrentValue, $this->operating_hours->ReadOnly);

        // best_time_to_visit
        $this->best_time_to_visit->setDbValueDef($rsnew, $this->best_time_to_visit->CurrentValue, $this->best_time_to_visit->ReadOnly);

        // how_to_get_there
        $this->how_to_get_there->setDbValueDef($rsnew, $this->how_to_get_there->CurrentValue, $this->how_to_get_there->ReadOnly);
    ...
    protected function restoreEditFormFromRow($row)
    {
        ...
        if (isset($row['entry_fee'])) { // entry_fee
            $this->entry_fee->CurrentValue = $row['entry_fee'];
        }
        ...
        if (isset($row['best_time_to_visit'])) { // best_time_to_visit
            $this->best_time_to_visit->CurrentValue = $row['best_time_to_visit'];
        }
        if (isset($row['how_to_get_there'])) { // how_to_get_there
            $this->how_to_get_there->CurrentValue = $row['how_to_get_there'];
        }
