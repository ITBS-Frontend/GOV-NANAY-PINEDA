 ...
 * Page class
 */
class FacilityTypesView extends FacilityTypes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FacilityTypesView";
    ...
    // CSS class/style
    public $CurrentPageName = "FacilityTypesView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "FacilityTypesList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "FacilityTypesList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
