 ...
 * Page class
 */
class ProjectStatsView extends ProjectStats
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProjectStatsView";
    ...
    // CSS class/style
    public $CurrentPageName = "ProjectStatsView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "ProjectStatsList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ProjectStatsList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
