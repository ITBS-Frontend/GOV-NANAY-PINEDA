 ...
 * Page class
 */
class TourismDestinationsList extends TourismDestinations
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TourismDestinationsList";
    ...
    public $FormName = "ftourism_destinationslist";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "TourismDestinationsList";
    ...
    public function setVisibility()
    {
        ...
        $this->how_to_get_there->Visible = false;
    ...
    public function __construct()
    {
        ...
        // Initialize URLs
        $this->AddUrl = "TourismDestinationsAdd?" . Config("TABLE_SHOW_DETAIL") . "=";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiEditUrl = $pageUrl . "action=multiedit";
        $this->MultiDeleteUrl = "TourismDestinationsDelete";
        $this->MultiUpdateUrl = "TourismDestinationsUpdate";
    ...
    public function run()
    {
        ...
        if ($this->IsModal) {
            $this->FormName = "ftourism_destinationsgrid";
        }
    ...
    public function getFilterList()
    {
        ...
        $filterList = Concat($filterList, $this->entry_fee->AdvancedSearch->toJson(), ","); // Field entry_fee
        $filterList = Concat($filterList, $this->operating_hours->AdvancedSearch->toJson(), ","); // Field operating_hours
        $filterList = Concat($filterList, $this->best_time_to_visit->AdvancedSearch->toJson(), ","); // Field best_time_to_visit
        $filterList = Concat($filterList, $this->how_to_get_there->AdvancedSearch->toJson(), ","); // Field how_to_get_there
        $filterList = Concat($filterList, $this->featured_image->AdvancedSearch->toJson(), ","); // Field featured_image
        $filterList = Concat($filterList, $this->is_featured->AdvancedSearch->toJson(), ","); // Field is_featured
    ...
    protected function processFilterList()
    {
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            Profile()->setSearchFilters("ftourism_destinationssrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field entry_fee
        $this->entry_fee->AdvancedSearch->SearchValue = @$filter["x_entry_fee"];
        $this->entry_fee->AdvancedSearch->SearchOperator = @$filter["z_entry_fee"];
        $this->entry_fee->AdvancedSearch->SearchCondition = @$filter["v_entry_fee"];
        $this->entry_fee->AdvancedSearch->SearchValue2 = @$filter["y_entry_fee"];
        $this->entry_fee->AdvancedSearch->SearchOperator2 = @$filter["w_entry_fee"];
        $this->entry_fee->AdvancedSearch->save();

        // Field operating_hours
        $this->operating_hours->AdvancedSearch->SearchValue = @$filter["x_operating_hours"];
        $this->operating_hours->AdvancedSearch->SearchOperator = @$filter["z_operating_hours"];
        $this->operating_hours->AdvancedSearch->SearchCondition = @$filter["v_operating_hours"];
        $this->operating_hours->AdvancedSearch->SearchValue2 = @$filter["y_operating_hours"];
        $this->operating_hours->AdvancedSearch->SearchOperator2 = @$filter["w_operating_hours"];
        $this->operating_hours->AdvancedSearch->save();

        // Field best_time_to_visit
        $this->best_time_to_visit->AdvancedSearch->SearchValue = @$filter["x_best_time_to_visit"];
        $this->best_time_to_visit->AdvancedSearch->SearchOperator = @$filter["z_best_time_to_visit"];
        $this->best_time_to_visit->AdvancedSearch->SearchCondition = @$filter["v_best_time_to_visit"];
        $this->best_time_to_visit->AdvancedSearch->SearchValue2 = @$filter["y_best_time_to_visit"];
        $this->best_time_to_visit->AdvancedSearch->SearchOperator2 = @$filter["w_best_time_to_visit"];
        $this->best_time_to_visit->AdvancedSearch->save();

        // Field how_to_get_there
        $this->how_to_get_there->AdvancedSearch->SearchValue = @$filter["x_how_to_get_there"];
        $this->how_to_get_there->AdvancedSearch->SearchOperator = @$filter["z_how_to_get_there"];
        $this->how_to_get_there->AdvancedSearch->SearchCondition = @$filter["v_how_to_get_there"];
        $this->how_to_get_there->AdvancedSearch->SearchValue2 = @$filter["y_how_to_get_there"];
        $this->how_to_get_there->AdvancedSearch->SearchOperator2 = @$filter["w_how_to_get_there"];
        $this->how_to_get_there->AdvancedSearch->save();
        ...
        // Field is_featured
        $this->is_featured->AdvancedSearch->SearchValue = @$filter["x_is_featured"];
        $this->is_featured->AdvancedSearch->SearchOperator = @$filter["z_is_featured"];
        $this->is_featured->AdvancedSearch->SearchCondition = @$filter["v_is_featured"];
        $this->is_featured->AdvancedSearch->SearchValue2 = @$filter["y_is_featured"];
        $this->is_featured->AdvancedSearch->SearchOperator2 = @$filter["w_is_featured"];
        $this->is_featured->AdvancedSearch->save();
    ...
    public function basicSearchWhere($default = false)
    {
        ...
        $searchFlds[] = &$this->entry_fee;
        $searchFlds[] = &$this->operating_hours;
        $searchFlds[] = &$this->best_time_to_visit;
        $searchFlds[] = &$this->how_to_get_there;
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->entry_fee); // entry_fee
            $this->updateSort($this->operating_hours); // operating_hours
            $this->updateSort($this->best_time_to_visit); // best_time_to_visit
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->entry_fee->setSort("");
                $this->operating_hours->setSort("");
                $this->best_time_to_visit->setSort("");
                $this->how_to_get_there->setSort("");
                $this->featured_image->setSort("");
                $this->is_featured->setSort("");
    ...
    protected function setupListOptions()
    {
        ...
        $item = &$this->ListOptions->add("detail_tourism_activities");
        $item->CssClass = "text-nowrap";
        ...
        $item = &$this->ListOptions->add("detail_destination_gallery");
        $item->CssClass = "text-nowrap";
        ...
        // Set up detail pages
        $pages = new SubPages();
        $pages->add("tourism_activities");
        $pages->add("destination_gallery");
    ...
    public function renderListOptions()
    {
        ...
        if ($this->CurrentMode == "view") {
            ...
            if ($Security->canView()) {
                if ($this->ModalView && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-view\" title=\"" . $viewcaption . "\" data-table=\"tourism_destinations\" data-caption=\"" . $viewcaption . "\" data-ew-action=\"modal\" data-action=\"view\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->ViewUrl)) . "\" data-btn=\"null\">" . $Language->phrase("ViewLink") . "</a>";
                } else {
            ...
            if ($Security->canEdit()) {
                if ($this->ModalEdit && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-edit\" title=\"" . $editcaption . "\" data-table=\"tourism_destinations\" data-caption=\"" . $editcaption . "\" data-ew-action=\"modal\" data-action=\"edit\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->EditUrl)) . "\" data-btn=\"SaveBtn\">" . $Language->phrase("EditLink") . "</a>";
                } else {
            ...
            if ($Security->canAdd()) {
                if ($this->ModalAdd && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-copy\" title=\"" . $copycaption . "\" data-table=\"tourism_destinations\" data-caption=\"" . $copycaption . "\" data-ew-action=\"modal\" data-action=\"add\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->CopyUrl)) . "\" data-btn=\"AddBtn\">" . $Language->phrase("CopyLink") . "</a>";
                } else {
                ...
                if ($listAction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    if ($action != "") {
                        ...
                        $link = $disabled
                            ...
                            : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"ftourism_destinationslist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listAction->toDataAttributes() . ">" . $icon . " " . $caption . "</button></li>";
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = $disabled
                            ? "<div class=\"alert alert-light\">" . $icon . " " . $caption . "</div>"
                            : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . $title . "\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"ftourism_destinationslist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listAction->toDataAttributes() . ">" . $icon . " " . $caption . "</button>";
                        }
                    }
                }
            }
        ...
        // "detail_tourism_activities"
        $opt = $this->ListOptions["detail_tourism_activities"];
        if ($Security->allowList(CurrentProjectID() . 'tourism_activities')) {
            $body = $Language->phrase("DetailLink") . $Language->tablePhrase("tourism_activities", "TblCaption");
            $body = "<a class=\"btn btn-default ew-row-link ew-detail" . ($this->ListOptions->UseDropDownButton ? " dropdown-toggle" : "") . "\" data-action=\"list\" href=\"" . HtmlEncode("TourismActivitiesList?" . Config("TABLE_SHOW_MASTER") . "=tourism_destinations&" . GetForeignKeyUrl("fk_id", $this->id->CurrentValue) . "") . "\">" . $body . "</a>";
            $links = "";
            $detailPage = Container("TourismActivitiesGrid");
            if ($detailPage->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'tourism_destinations')) {
                $caption = $Language->phrase("MasterDetailViewLink", null);
                $url = $this->getViewUrl(Config("TABLE_SHOW_DETAIL") . "=tourism_activities");
            ...
            if ($detailPage->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'tourism_destinations')) {
                $caption = $Language->phrase("MasterDetailEditLink", null);
                $url = $this->getEditUrl(Config("TABLE_SHOW_DETAIL") . "=tourism_activities");
            ...
            if ($detailPage->DetailAdd && $Security->canAdd() && $Security->allowAdd(CurrentProjectID() . 'tourism_destinations')) {
                $caption = $Language->phrase("MasterDetailCopyLink", null);
                $url = $this->getCopyUrl(Config("TABLE_SHOW_DETAIL") . "=tourism_activities");
        ...
        // "detail_destination_gallery"
        $opt = $this->ListOptions["detail_destination_gallery"];
        if ($Security->allowList(CurrentProjectID() . 'destination_gallery')) {
            $body = $Language->phrase("DetailLink") . $Language->tablePhrase("destination_gallery", "TblCaption");
            $body = "<a class=\"btn btn-default ew-row-link ew-detail" . ($this->ListOptions->UseDropDownButton ? " dropdown-toggle" : "") . "\" data-action=\"list\" href=\"" . HtmlEncode("DestinationGalleryList?" . Config("TABLE_SHOW_MASTER") . "=tourism_destinations&" . GetForeignKeyUrl("fk_id", $this->id->CurrentValue) . "") . "\">" . $body . "</a>";
            $links = "";
            $detailPage = Container("DestinationGalleryGrid");
            if ($detailPage->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'tourism_destinations')) {
                $caption = $Language->phrase("MasterDetailViewLink", null);
                $url = $this->getViewUrl(Config("TABLE_SHOW_DETAIL") . "=destination_gallery");
                $links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-view\" data-action=\"view\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode($url) . "\">" . $caption . "</a></li>";
                if ($detailViewTblVar != "") {
                    $detailViewTblVar .= ",";
                }
            ...
            if ($detailPage->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'tourism_destinations')) {
                $caption = $Language->phrase("MasterDetailEditLink", null);
                $url = $this->getEditUrl(Config("TABLE_SHOW_DETAIL") . "=destination_gallery");
                $links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-edit\" data-action=\"edit\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode($url) . "\">" . $caption . "</a></li>";
                if ($detailEditTblVar != "") {
                    $detailEditTblVar .= ",";
                }
            ...
            if ($detailPage->DetailAdd && $Security->canAdd() && $Security->allowAdd(CurrentProjectID() . 'tourism_destinations')) {
                $caption = $Language->phrase("MasterDetailCopyLink", null);
                $url = $this->getCopyUrl(Config("TABLE_SHOW_DETAIL") . "=destination_gallery");
                $links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-copy\" data-action=\"add\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode($url) . "\">" . $caption . "</a></li>";
                if ($detailCopyTblVar != "") {
                    $detailCopyTblVar .= ",";
                }
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->ModalAdd && !IsMobile()) {
            $item->Body = "<a class=\"ew-add-edit ew-add\" title=\"" . $addcaption . "\" data-table=\"tourism_destinations\" data-caption=\"" . $addcaption . "\" data-ew-action=\"modal\" data-action=\"add\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->AddUrl)) . "\" data-btn=\"AddBtn\">" . $Language->phrase("AddLink") . "</a>";
        } else {
        ...
        $detailTableLink = "";
        $item = &$option->add("detailadd_tourism_activities");
        $url = $this->getAddUrl(Config("TABLE_SHOW_DETAIL") . "=tourism_activities");
        $detailPage = Container("TourismActivitiesGrid");
        $caption = $Language->phrase("Add") . "&nbsp;" . $this->tableCaption() . "/" . $detailPage->tableCaption();
        $item->Body = "<a class=\"ew-detail-add-group ew-detail-add\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode(GetUrl($url)) . "\">" . $caption . "</a>";
        $item->Visible = ($detailPage->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'tourism_destinations') && $Security->canAdd());
        if ($item->Visible) {
            if ($detailTableLink != "") {
                $detailTableLink .= ",";
            }
        ...
        $item = &$option->add("detailadd_destination_gallery");
        $url = $this->getAddUrl(Config("TABLE_SHOW_DETAIL") . "=destination_gallery");
        $detailPage = Container("DestinationGalleryGrid");
        $caption = $Language->phrase("Add") . "&nbsp;" . $this->tableCaption() . "/" . $detailPage->tableCaption();
        $item->Body = "<a class=\"ew-detail-add-group ew-detail-add\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode(GetUrl($url)) . "\">" . $caption . "</a>";
        $item->Visible = ($detailPage->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'tourism_destinations') && $Security->canAdd());
        ...
        if ($this->UseColumnVisibility) {
            ...
            $this->createColumnOption($option, "entry_fee");
            $this->createColumnOption($option, "operating_hours");
            $this->createColumnOption($option, "best_time_to_visit");
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"ftourism_destinationssrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"ftourism_destinationssrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions as $listAction) {
            if ($listAction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="ftourism_destinationslist"' . $listAction->toDataAttributes() . '>' . $icon . '</button>';
    ...
    public function setupRow()
    {
        ...
        if ($this->isGridAdd() || $this->isGridEdit()) {
            if ($this->RowIndex === '$rowindex$') { // Render template row first
                ...
                // Set row properties
                $this->resetAttributes();
                $this->RowAttrs->merge(["data-rowindex" => $this->RowIndex, "id" => "r0_tourism_destinations", "data-rowtype" => RowType::ADD]);
        ...
        $this->RowAttrs->merge([
            ...
            "id" => "r" . $this->RowCount . "_tourism_destinations",
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == RowType::VIEW) {
            ...
            if ($this->featured_image->UseColorbox) {
                ...
                $this->featured_image->LinkAttrs["data-rel"] = "tourism_destinations_x" . $this->RowCount . "_featured_image";
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"ftourism_destinationssrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
