 ...
 * Page class
 */
class ProjectHighlightsEdit extends ProjectHighlights
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProjectHighlightsEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "ProjectHighlightsEdit";
    ...
    protected function getEditRow($rsold)
    {
        ...
        // highlight_text
        $this->highlight_text->setDbValueDef($rsnew, $this->highlight_text->CurrentValue, $this->highlight_text->ReadOnly);
    ...
    protected function restoreEditFormFromRow($row)
    {
        ...
        if (isset($row['highlight_text'])) { // highlight_text
            $this->highlight_text->CurrentValue = $row['highlight_text'];
        }
