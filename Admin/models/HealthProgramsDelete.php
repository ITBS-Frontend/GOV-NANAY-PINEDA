 ...
 * Page class
 */
class HealthProgramsDelete extends HealthPrograms
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "HealthProgramsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "HealthProgramsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("HealthProgramsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("HealthProgramsList"); // Return to list
                return;
            }
        }
