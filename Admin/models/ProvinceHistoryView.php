 ...
 * Page class
 */
class ProvinceHistoryView extends ProvinceHistory
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProvinceHistoryView";
    ...
    // CSS class/style
    public $CurrentPageName = "ProvinceHistoryView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "ProvinceHistoryList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ProvinceHistoryList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
