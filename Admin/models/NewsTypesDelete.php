 ...
 * Page class
 */
class NewsTypesDelete extends NewsTypes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NewsTypesDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "NewsTypesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("NewsTypesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("NewsTypesList"); // Return to list
                return;
            }
        }
