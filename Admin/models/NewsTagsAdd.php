 ...
 * Page class
 */
class NewsTagsAdd extends NewsTags
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NewsTagsAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "NewsTagsAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("NewsTagsList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "NewsTagsList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "NewsTagsView") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "NewsTagsList") {
                            ...
                            $returnUrl = "NewsTagsList"; // Return list page content
                        }
                    }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("NewsTagsList"), "", $this->TableVar, true);
