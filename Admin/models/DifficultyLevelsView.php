 ...
 * Page class
 */
class DifficultyLevelsView extends DifficultyLevels
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DifficultyLevelsView";
    ...
    // CSS class/style
    public $CurrentPageName = "DifficultyLevelsView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "DifficultyLevelsList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "DifficultyLevelsList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
