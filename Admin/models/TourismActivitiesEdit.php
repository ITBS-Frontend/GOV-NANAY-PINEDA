 ...
 * Page class
 */
class TourismActivitiesEdit extends TourismActivities
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TourismActivitiesEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "TourismActivitiesEdit";
    ...
    protected function getEditRow($rsold)
    {
        ...
        // difficulty_level
        $this->difficulty_level->setDbValueDef($rsnew, $this->difficulty_level->CurrentValue, $this->difficulty_level->ReadOnly);
    ...
    protected function restoreEditFormFromRow($row)
    {
        ...
        if (isset($row['difficulty_level'])) { // difficulty_level
            $this->difficulty_level->CurrentValue = $row['difficulty_level'];
        }
