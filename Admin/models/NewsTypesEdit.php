 ...
 * Page class
 */
class NewsTypesEdit extends NewsTypes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NewsTypesEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "NewsTypesEdit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("NewsTypesList"); // No matching record, return to list
                        return;
                    }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "NewsTypesList") {
                ...
                if ($this->editRow()) { // Update record based on key
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "NewsTypesList") {
                            ...
                            $returnUrl = "NewsTypesList"; // Return list page content
                        }
                    }
                    if (IsJsonResponse()) {
                        $this->terminate(true);
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("NewsTypesList"), "", $this->TableVar, true);
        $pageId = "edit";
