 ...
 * Page class
 */
class CategoryTypesAdd extends CategoryTypes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CategoryTypesAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "CategoryTypesAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("CategoryTypesList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "CategoryTypesList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "CategoryTypesView") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "CategoryTypesList") {
                            ...
                            $returnUrl = "CategoryTypesList"; // Return list page content
                        }
                    }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("CategoryTypesList"), "", $this->TableVar, true);
