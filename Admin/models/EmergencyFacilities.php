...
/**
 * Table class for emergency_facilities
 */
class EmergencyFacilities extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "emergency_facilities";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // capacity
        $this->capacity = new DbField(
            $this, // Table
            'x_capacity', // Variable name
            'capacity', // Name
            '"capacity"', // Expression
            'CAST("capacity" AS varchar(255))', // Basic search expression
            3, // Type
            0, // Size
            -1, // Date/Time format
            false, // Is upload field
            '"capacity"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->capacity->InputTextType = "text";
        $this->capacity->Raw = true;
        $this->capacity->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->capacity->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        ...
        $this->is_active->Lookup = new Lookup($this->is_active, 'emergency_facilities', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "emergency_facilities";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("EmergencyFacilitiesList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "EmergencyFacilitiesView" => $Language->phrase("View"),
            "EmergencyFacilitiesEdit" => $Language->phrase("Edit"),
            "EmergencyFacilitiesAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    {
        return "EmergencyFacilitiesList";
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "EmergencyFacilitiesView",
            Config("API_ADD_ACTION") => "EmergencyFacilitiesAdd",
            Config("API_EDIT_ACTION") => "EmergencyFacilitiesEdit",
            Config("API_DELETE_ACTION") => "EmergencyFacilitiesDelete",
            Config("API_LIST_ACTION") => "EmergencyFacilitiesList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("EmergencyFacilitiesView", $parm);
        } else {
            $url = $this->keyUrl("EmergencyFacilitiesView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "EmergencyFacilitiesAdd?" . $parm;
        } else {
            $url = "EmergencyFacilitiesAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("EmergencyFacilitiesEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("EmergencyFacilitiesList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("EmergencyFacilitiesAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("EmergencyFacilitiesList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("EmergencyFacilitiesDelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "EmergencyFacilitiesList";
