 ...
 * Page class
 */
class ProjectGalleryDelete extends ProjectGallery
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProjectGalleryDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ProjectGalleryDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ProjectGalleryList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ProjectGalleryList"); // Return to list
                return;
            }
        }
