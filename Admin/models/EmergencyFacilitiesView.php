 ...
 * Page class
 */
class EmergencyFacilitiesView extends EmergencyFacilities
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmergencyFacilitiesView";
    ...
    // CSS class/style
    public $CurrentPageName = "EmergencyFacilitiesView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "EmergencyFacilitiesList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "EmergencyFacilitiesList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
