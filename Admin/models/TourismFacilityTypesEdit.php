 ...
 * Page class
 */
class TourismFacilityTypesEdit extends TourismFacilityTypes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TourismFacilityTypesEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "TourismFacilityTypesEdit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("TourismFacilityTypesList"); // No matching record, return to list
                        return;
                    }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "TourismFacilityTypesList") {
                ...
                if ($this->editRow()) { // Update record based on key
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "TourismFacilityTypesList") {
                            ...
                            $returnUrl = "TourismFacilityTypesList"; // Return list page content
                        }
                    }
                    if (IsJsonResponse()) {
                        $this->terminate(true);
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("TourismFacilityTypesList"), "", $this->TableVar, true);
        $pageId = "edit";
