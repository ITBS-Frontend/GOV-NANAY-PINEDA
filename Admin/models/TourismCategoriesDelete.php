 ...
 * Page class
 */
class TourismCategoriesDelete extends TourismCategories
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TourismCategoriesDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "TourismCategoriesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("TourismCategoriesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("TourismCategoriesList"); // Return to list
                return;
            }
        }
