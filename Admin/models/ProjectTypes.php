...
/**
 * Table class for project_types
 */
class ProjectTypes extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "project_types";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->color_code = new DbField(
            $this, // Table
            'x_color_code', // Variable name
            'color_code', // Name
            '"color_code"', // Expression
            '"color_code"', // Basic search expression
            200, // Type
            7, // Size
            -1, // Date/Time format
            false, // Is upload field
            '"color_code"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->color_code->addMethod("getDefault", fn() => "#3b82f6");
        $this->color_code->InputTextType = "text";
        $this->color_code->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        ...
        $this->is_active->Lookup = new Lookup($this->is_active, 'project_types', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "project_types";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ProjectTypesList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "ProjectTypesView" => $Language->phrase("View"),
            "ProjectTypesEdit" => $Language->phrase("Edit"),
            "ProjectTypesAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ProjectTypesView",
            Config("API_ADD_ACTION") => "ProjectTypesAdd",
            Config("API_EDIT_ACTION") => "ProjectTypesEdit",
            Config("API_DELETE_ACTION") => "ProjectTypesDelete",
            Config("API_LIST_ACTION") => "ProjectTypesList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ProjectTypesView", $parm);
        } else {
            $url = $this->keyUrl("ProjectTypesView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ProjectTypesEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ProjectTypesList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ProjectTypesAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ProjectTypesList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ProjectTypesDelete", $parm);
        }
    }
