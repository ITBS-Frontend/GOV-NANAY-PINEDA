...
/**
 * Table class for government_facilities
 */
class GovernmentFacilities extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "government_facilities";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // services_offered
        $this->services_offered = new DbField(
            $this, // Table
            'x_services_offered', // Variable name
            'services_offered', // Name
            '"services_offered"', // Expression
            '"services_offered"', // Basic search expression
            201, // Type
            0, // Size
            -1, // Date/Time format
            false, // Is upload field
            '"services_offered"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->services_offered->InputTextType = "text";
        $this->services_offered->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['services_offered'] = &$this->services_offered;
        ...
        $this->is_active->Lookup = new Lookup($this->is_active, 'government_facilities', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->facility_type_id->Lookup = new Lookup($this->facility_type_id, 'facility_types', false, 'id', ["type_name","","",""], '', '', [], [], [], [], [], [], false, '', '', "\"type_name\"");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "government_facilities";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->services_offered->DbValue = $row['services_offered'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("GovernmentFacilitiesList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "GovernmentFacilitiesView" => $Language->phrase("View"),
            "GovernmentFacilitiesEdit" => $Language->phrase("Edit"),
            "GovernmentFacilitiesAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    {
        return "GovernmentFacilitiesList";
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "GovernmentFacilitiesView",
            Config("API_ADD_ACTION") => "GovernmentFacilitiesAdd",
            Config("API_EDIT_ACTION") => "GovernmentFacilitiesEdit",
            Config("API_DELETE_ACTION") => "GovernmentFacilitiesDelete",
            Config("API_LIST_ACTION") => "GovernmentFacilitiesList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("GovernmentFacilitiesView", $parm);
        } else {
            $url = $this->keyUrl("GovernmentFacilitiesView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "GovernmentFacilitiesAdd?" . $parm;
        } else {
            $url = "GovernmentFacilitiesAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("GovernmentFacilitiesEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("GovernmentFacilitiesList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("GovernmentFacilitiesAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("GovernmentFacilitiesList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("GovernmentFacilitiesDelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "GovernmentFacilitiesList";
    ...
    public function renderListRow()
    {
        ...
        $this->services_offered->TooltipValue = "";
    ...
    public function renderEditRow()
    {
        ...
        $this->services_offered->EditValue = $this->services_offered->CurrentValue;
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->services_offered);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->services_offered);
