...
/**
 * Table class for economic_indicators
 */
class EconomicIndicators extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "economic_indicators";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // indicator_name
        $this->indicator_name = new DbField(
            $this, // Table
            'x_indicator_name', // Variable name
            'indicator_name', // Name
            '"indicator_name"', // Expression
            '"indicator_name"', // Basic search expression
            200, // Type
            255, // Size
            -1, // Date/Time format
            false, // Is upload field
            '"indicator_name"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->indicator_name->InputTextType = "text";
        $this->indicator_name->Nullable = false; // NOT NULL field
        $this->indicator_name->Required = true; // Required field
        $this->indicator_name->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
        $this->Fields['indicator_name'] = &$this->indicator_name;

        // value
        $this->value = new DbField(
            $this, // Table
            'x_value', // Variable name
            'value', // Name
            '"value"', // Expression
            '"value"', // Basic search expression
            200, // Type
            100, // Size
            -1, // Date/Time format
            false, // Is upload field
            '"value"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->value->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
        ...
        $this->year = new DbField(
            ...
            'year', // Name
            '"year"', // Expression
            'CAST("year" AS varchar(255))', // Basic search expression
            3, // Type
            0, // Size
            -1, // Date/Time format
            false, // Is upload field
        ...
        // quarter
        $this->quarter = new DbField(
            $this, // Table
            'x_quarter', // Variable name
            'quarter', // Name
            '"quarter"', // Expression
            '"quarter"', // Basic search expression
            200, // Type
            10, // Size
            -1, // Date/Time format
            false, // Is upload field
            '"quarter"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->quarter->InputTextType = "text";
        $this->quarter->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['quarter'] = &$this->quarter;

        // source
        $this->source = new DbField(
            $this, // Table
            'x_source', // Variable name
            'source', // Name
            '"source"', // Expression
            '"source"', // Basic search expression
            200, // Type
            255, // Size
            -1, // Date/Time format
            false, // Is upload field
            '"source"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->source->InputTextType = "text";
        $this->source->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "economic_indicators";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->quarter->DbValue = $row['quarter'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("EconomicIndicatorsList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "EconomicIndicatorsView" => $Language->phrase("View"),
            "EconomicIndicatorsEdit" => $Language->phrase("Edit"),
            "EconomicIndicatorsAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "EconomicIndicatorsView",
            Config("API_ADD_ACTION") => "EconomicIndicatorsAdd",
            Config("API_EDIT_ACTION") => "EconomicIndicatorsEdit",
            Config("API_DELETE_ACTION") => "EconomicIndicatorsDelete",
            Config("API_LIST_ACTION") => "EconomicIndicatorsList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("EconomicIndicatorsView", $parm);
        } else {
            $url = $this->keyUrl("EconomicIndicatorsView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "EconomicIndicatorsAdd?" . $parm;
        } else {
            $url = "EconomicIndicatorsAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("EconomicIndicatorsEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("EconomicIndicatorsList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("EconomicIndicatorsAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("EconomicIndicatorsList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("EconomicIndicatorsDelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "EconomicIndicatorsList";
    ...
    public function renderEditRow()
    {
        ...
        $this->quarter->EditValue = $this->quarter->CurrentValue;
        ...
        $this->source->EditValue = $this->source->CurrentValue;
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->quarter);
