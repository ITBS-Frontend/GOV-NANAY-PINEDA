 ...
 * Page class
 */
class CategoryTypesDelete extends CategoryTypes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CategoryTypesDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "CategoryTypesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("CategoryTypesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("CategoryTypesList"); // Return to list
                return;
            }
        }
