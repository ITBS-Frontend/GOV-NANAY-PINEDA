 ...
 * Page class
 */
class DemographicsTypesAdd extends DemographicsTypes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DemographicsTypesAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "DemographicsTypesAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("DemographicsTypesList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "DemographicsTypesList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "DemographicsTypesView") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "DemographicsTypesList") {
                            ...
                            $returnUrl = "DemographicsTypesList"; // Return list page content
                        }
                    }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("DemographicsTypesList"), "", $this->TableVar, true);
