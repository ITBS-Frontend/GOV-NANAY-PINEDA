 ...
 * Page class
 */
class GeographicInfoTypesAdd extends GeographicInfoTypes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "GeographicInfoTypesAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "GeographicInfoTypesAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("GeographicInfoTypesList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "GeographicInfoTypesList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "GeographicInfoTypesView") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "GeographicInfoTypesList") {
                            ...
                            $returnUrl = "GeographicInfoTypesList"; // Return list page content
                        }
                    }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("GeographicInfoTypesList"), "", $this->TableVar, true);
