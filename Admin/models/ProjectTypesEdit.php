 ...
 * Page class
 */
class ProjectTypesEdit extends ProjectTypes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProjectTypesEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "ProjectTypesEdit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("ProjectTypesList"); // No matching record, return to list
                        return;
                    }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "ProjectTypesList") {
                ...
                if ($this->editRow()) { // Update record based on key
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "ProjectTypesList") {
                            ...
                            $returnUrl = "ProjectTypesList"; // Return list page content
                        }
                    }
                    if (IsJsonResponse()) {
                        $this->terminate(true);
    ...
    protected function getEditRow($rsold)
    {
        ...
        // color_code
        $this->color_code->setDbValueDef($rsnew, $this->color_code->CurrentValue, $this->color_code->ReadOnly);
    ...
    protected function restoreEditFormFromRow($row)
    {
        ...
        if (isset($row['color_code'])) { // color_code
            $this->color_code->CurrentValue = $row['color_code'];
        }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("ProjectTypesList"), "", $this->TableVar, true);
        $pageId = "edit";
