 ...
 * Page class
 */
class DisasterTypesView extends DisasterTypes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DisasterTypesView";
    ...
    // CSS class/style
    public $CurrentPageName = "DisasterTypesView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "DisasterTypesList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "DisasterTypesList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
