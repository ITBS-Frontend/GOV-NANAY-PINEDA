...
/**
 * Table class for demographics_types
 */
class DemographicsTypes extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "demographics_types";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->is_active->Lookup = new Lookup($this->is_active, 'demographics_types', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "demographics_types";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("DemographicsTypesList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "DemographicsTypesView" => $Language->phrase("View"),
            "DemographicsTypesEdit" => $Language->phrase("Edit"),
            "DemographicsTypesAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "DemographicsTypesView",
            Config("API_ADD_ACTION") => "DemographicsTypesAdd",
            Config("API_EDIT_ACTION") => "DemographicsTypesEdit",
            Config("API_DELETE_ACTION") => "DemographicsTypesDelete",
            Config("API_LIST_ACTION") => "DemographicsTypesList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("DemographicsTypesView", $parm);
        } else {
            $url = $this->keyUrl("DemographicsTypesView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "DemographicsTypesAdd?" . $parm;
        } else {
            $url = "DemographicsTypesAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DemographicsTypesEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DemographicsTypesList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DemographicsTypesAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DemographicsTypesList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("DemographicsTypesDelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "DemographicsTypesList";
