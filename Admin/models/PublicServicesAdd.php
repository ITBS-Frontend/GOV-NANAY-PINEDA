 ...
 * Page class
 */
class PublicServicesAdd extends PublicServices
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PublicServicesAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "PublicServicesAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "PublicServicesView") {
    ...
    protected function getAddRow()
    {
        ...
        // requirements
        $this->requirements->setDbValueDef($rsnew, $this->requirements->CurrentValue, false);

        // process_steps
        $this->process_steps->setDbValueDef($rsnew, $this->process_steps->CurrentValue, false);

        // processing_time
        $this->processing_time->setDbValueDef($rsnew, $this->processing_time->CurrentValue, false);

        // fees
        $this->fees->setDbValueDef($rsnew, $this->fees->CurrentValue, false);

        // contact_info
        $this->contact_info->setDbValueDef($rsnew, $this->contact_info->CurrentValue, false);

        // online_link
        $this->online_link->setDbValueDef($rsnew, $this->online_link->CurrentValue, false);
    ...
    protected function restoreAddFormFromRow($row)
    {
        ...
        if (isset($row['requirements'])) { // requirements
            $this->requirements->setFormValue($row['requirements']);
        }
        if (isset($row['process_steps'])) { // process_steps
            $this->process_steps->setFormValue($row['process_steps']);
        }
        if (isset($row['processing_time'])) { // processing_time
            $this->processing_time->setFormValue($row['processing_time']);
        }
        if (isset($row['fees'])) { // fees
            $this->fees->setFormValue($row['fees']);
        }
        ...
        if (isset($row['online_link'])) { // online_link
            $this->online_link->setFormValue($row['online_link']);
        }
