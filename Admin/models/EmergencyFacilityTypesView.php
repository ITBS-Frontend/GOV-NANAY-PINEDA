 ...
 * Page class
 */
class EmergencyFacilityTypesView extends EmergencyFacilityTypes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmergencyFacilityTypesView";
    ...
    // CSS class/style
    public $CurrentPageName = "EmergencyFacilityTypesView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "EmergencyFacilityTypesList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "EmergencyFacilityTypesList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
