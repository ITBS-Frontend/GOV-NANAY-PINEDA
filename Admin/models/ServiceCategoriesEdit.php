 ...
 * Page class
 */
class ServiceCategoriesEdit extends ServiceCategories
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ServiceCategoriesEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "ServiceCategoriesEdit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("ServiceCategoriesList"); // No matching record, return to list
                        return;
                    }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "ServiceCategoriesList") {
                ...
                if ($this->editRow()) { // Update record based on key
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "ServiceCategoriesList") {
                            ...
                            $returnUrl = "ServiceCategoriesList"; // Return list page content
                        }
                    }
                    if (IsJsonResponse()) {
                        $this->terminate(true);
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("ServiceCategoriesList"), "", $this->TableVar, true);
        $pageId = "edit";
