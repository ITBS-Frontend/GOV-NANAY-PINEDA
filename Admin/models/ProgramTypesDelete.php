 ...
 * Page class
 */
class ProgramTypesDelete extends ProgramTypes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProgramTypesDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ProgramTypesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ProgramTypesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ProgramTypesList"); // Return to list
                return;
            }
        }
