...
/**
 * Table class for geographic_info
 */
class GeographicInfo extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "geographic_info";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "geographic_info";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("GeographicInfoList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "GeographicInfoView" => $Language->phrase("View"),
            "GeographicInfoEdit" => $Language->phrase("Edit"),
            "GeographicInfoAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "GeographicInfoView",
            Config("API_ADD_ACTION") => "GeographicInfoAdd",
            Config("API_EDIT_ACTION") => "GeographicInfoEdit",
            Config("API_DELETE_ACTION") => "GeographicInfoDelete",
            Config("API_LIST_ACTION") => "GeographicInfoList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("GeographicInfoView", $parm);
        } else {
            $url = $this->keyUrl("GeographicInfoView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "GeographicInfoAdd?" . $parm;
        } else {
            $url = "GeographicInfoAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("GeographicInfoEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("GeographicInfoList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("GeographicInfoAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("GeographicInfoList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("GeographicInfoDelete", $parm);
        }
    }
