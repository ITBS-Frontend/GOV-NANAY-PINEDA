...
/**
 * Table class for program_statistics
 */
class ProgramStatistics extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "program_statistics";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // program_id
        $this->program_id = new DbField(
            $this, // Table
            'x_program_id', // Variable name
            'program_id', // Name
            '"program_id"', // Expression
            'CAST("program_id" AS varchar(255))', // Basic search expression
            3, // Type
            0, // Size
            -1, // Date/Time format
            false, // Is upload field
            '"program_id"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->program_id->InputTextType = "text";
        $this->program_id->Raw = true;
        $this->program_id->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "program_statistics";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ProgramStatisticsList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "ProgramStatisticsView" => $Language->phrase("View"),
            "ProgramStatisticsEdit" => $Language->phrase("Edit"),
            "ProgramStatisticsAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ProgramStatisticsView",
            Config("API_ADD_ACTION") => "ProgramStatisticsAdd",
            Config("API_EDIT_ACTION") => "ProgramStatisticsEdit",
            Config("API_DELETE_ACTION") => "ProgramStatisticsDelete",
            Config("API_LIST_ACTION") => "ProgramStatisticsList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ProgramStatisticsView", $parm);
        } else {
            $url = $this->keyUrl("ProgramStatisticsView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "ProgramStatisticsAdd?" . $parm;
        } else {
            $url = "ProgramStatisticsAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ProgramStatisticsEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ProgramStatisticsList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ProgramStatisticsAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ProgramStatisticsList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ProgramStatisticsDelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "ProgramStatisticsList";
    ...
    public function renderEditRow()
    {
        ...
        // program_id
        $this->program_id->setupEditAttributes();
