 ...
 * Page class
 */
class DemographicsDataAdd extends DemographicsData
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DemographicsDataAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "DemographicsDataAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("DemographicsDataList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "DemographicsDataList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "DemographicsDataView") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "DemographicsDataList") {
                            ...
                            $returnUrl = "DemographicsDataList"; // Return list page content
                        }
                    }
    ...
    protected function getAddRow()
    {
        ...
        // data_type_id
        $this->data_type_id->setDbValueDef($rsnew, $this->data_type_id->CurrentValue, false);
        return $rsnew;
    }
    ...
    protected function restoreAddFormFromRow($row)
    {
        ...
        if (isset($row['data_type_id'])) { // data_type_id
            $this->data_type_id->setFormValue($row['data_type_id']);
        }
    }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("DemographicsDataList"), "", $this->TableVar, true);
