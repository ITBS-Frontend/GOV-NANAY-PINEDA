...
/**
 * Table class for municipalities
 */
class Municipalities extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "municipalities";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // population
        $this->population = new DbField(
            $this, // Table
            'x_population', // Variable name
            'population', // Name
            '"population"', // Expression
            'CAST("population" AS varchar(255))', // Basic search expression
            3, // Type
            0, // Size
            -1, // Date/Time format
            false, // Is upload field
            '"population"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->population->InputTextType = "text";
        $this->population->Raw = true;
        $this->population->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->population->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        $this->Fields['population'] = &$this->population;

        // area_sqkm
        $this->area_sqkm = new DbField(
            $this, // Table
            'x_area_sqkm', // Variable name
            'area_sqkm', // Name
            '"area_sqkm"', // Expression
            'CAST("area_sqkm" AS varchar(255))', // Basic search expression
            14, // Type
            0, // Size
            -1, // Date/Time format
            false, // Is upload field
            '"area_sqkm"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->area_sqkm->InputTextType = "text";
        $this->area_sqkm->Raw = true;
        $this->area_sqkm->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->area_sqkm->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        $this->Fields['area_sqkm'] = &$this->area_sqkm;
        ...
        // mayor_name
        $this->mayor_name = new DbField(
            $this, // Table
            'x_mayor_name', // Variable name
            'mayor_name', // Name
            '"mayor_name"', // Expression
            '"mayor_name"', // Basic search expression
            200, // Type
            255, // Size
            -1, // Date/Time format
            false, // Is upload field
            '"mayor_name"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->mayor_name->InputTextType = "text";
        $this->mayor_name->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['mayor_name'] = &$this->mayor_name;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "municipalities";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->mayor_name->DbValue = $row['mayor_name'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("MunicipalitiesList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "MunicipalitiesView" => $Language->phrase("View"),
            "MunicipalitiesEdit" => $Language->phrase("Edit"),
            "MunicipalitiesAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "MunicipalitiesView",
            Config("API_ADD_ACTION") => "MunicipalitiesAdd",
            Config("API_EDIT_ACTION") => "MunicipalitiesEdit",
            Config("API_DELETE_ACTION") => "MunicipalitiesDelete",
            Config("API_LIST_ACTION") => "MunicipalitiesList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("MunicipalitiesView", $parm);
        } else {
            $url = $this->keyUrl("MunicipalitiesView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "MunicipalitiesAdd?" . $parm;
        } else {
            $url = "MunicipalitiesAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("MunicipalitiesEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("MunicipalitiesList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("MunicipalitiesAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("MunicipalitiesList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("MunicipalitiesDelete", $parm);
        }
    }
    ...
    public function renderEditRow()
    {
        ...
        $this->mayor_name->EditValue = $this->mayor_name->CurrentValue;
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->mayor_name);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->mayor_name);
