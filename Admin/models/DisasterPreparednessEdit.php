 ...
 * Page class
 */
class DisasterPreparednessEdit extends DisasterPreparedness
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DisasterPreparednessEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "DisasterPreparednessEdit";
    ...
    protected function getEditRow($rsold)
    {
        ...
        // emergency_hotlines
        $this->emergency_hotlines->setDbValueDef($rsnew, $this->emergency_hotlines->CurrentValue, $this->emergency_hotlines->ReadOnly);

        // evacuation_centers
        $this->evacuation_centers->setDbValueDef($rsnew, $this->evacuation_centers->CurrentValue, $this->evacuation_centers->ReadOnly);
    ...
    protected function restoreEditFormFromRow($row)
    {
        ...
        if (isset($row['emergency_hotlines'])) { // emergency_hotlines
            $this->emergency_hotlines->CurrentValue = $row['emergency_hotlines'];
        }
        if (isset($row['evacuation_centers'])) { // evacuation_centers
            $this->evacuation_centers->CurrentValue = $row['evacuation_centers'];
        }
        if (isset($row['relief_procedures'])) { // relief_procedures
            $this->relief_procedures->CurrentValue = $row['relief_procedures'];
        }
