...
class UserLevelsEdit extends UserLevels
{
    ...
    protected function editRow()
    {
        ...
        // Check field with unique index (user_level_id)
        if ($this->user_level_id->CurrentValue != "") {
            $filterChk = "(\"user_level_id\" = " . AdjustSql($this->user_level_id->CurrentValue, $this->Dbid) . ")";
    ...
    protected function restoreEditFormFromRow($row)
    {
        ...
        if (isset($row['user_level_name'])) { // user_level_name
            $this->user_level_name->CurrentValue = $row['user_level_name'];
        }
