...
class Users extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->user_level_id->addMethod("getDefault", fn() => 0);
        ...
        $this->user_level_id->Lookup = new Lookup($this->user_level_id, '_user_levels', false, 'user_level_id', ["user_level_name","","",""], '', '', [], [], [], [], [], [], false, '', '', "\"user_level_name\"");
        ...
        $this->activated = new DbField(
            ...
            'CAST("activated" AS varchar(255))', // Basic search expression
            11, // Type
            0, // Size
            -1, // Date/Time format
            false, // Is upload field
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->activated->DbValue = (ConvertToBool($row['activated']) ? "1" : "0");
