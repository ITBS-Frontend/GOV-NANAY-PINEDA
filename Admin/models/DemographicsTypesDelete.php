 ...
 * Page class
 */
class DemographicsTypesDelete extends DemographicsTypes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DemographicsTypesDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "DemographicsTypesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("DemographicsTypesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("DemographicsTypesList"); // Return to list
                return;
            }
        }
