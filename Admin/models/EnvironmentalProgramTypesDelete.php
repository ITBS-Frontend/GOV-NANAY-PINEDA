 ...
 * Page class
 */
class EnvironmentalProgramTypesDelete extends EnvironmentalProgramTypes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EnvironmentalProgramTypesDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "EnvironmentalProgramTypesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("EnvironmentalProgramTypesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("EnvironmentalProgramTypesList"); // Return to list
                return;
            }
        }
