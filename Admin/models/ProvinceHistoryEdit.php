 ...
 * Page class
 */
class ProvinceHistoryEdit extends ProvinceHistory
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProvinceHistoryEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "ProvinceHistoryEdit";
    ...
    protected function getEditRow($rsold)
    {
        ...
        // period
        $this->period->setDbValueDef($rsnew, $this->period->CurrentValue, $this->period->ReadOnly);
