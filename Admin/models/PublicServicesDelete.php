 ...
 * Page class
 */
class PublicServicesDelete extends PublicServices
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PublicServicesDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "PublicServicesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PublicServicesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("PublicServicesList"); // Return to list
                return;
            }
        }
