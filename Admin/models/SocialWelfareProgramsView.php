 ...
 * Page class
 */
class SocialWelfareProgramsView extends SocialWelfarePrograms
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SocialWelfareProgramsView";
    ...
    // CSS class/style
    public $CurrentPageName = "SocialWelfareProgramsView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "SocialWelfareProgramsList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "SocialWelfareProgramsList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
