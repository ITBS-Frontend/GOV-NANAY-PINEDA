 ...
 * Page class
 */
class GeographicInfoTypesDelete extends GeographicInfoTypes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "GeographicInfoTypesDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "GeographicInfoTypesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("GeographicInfoTypesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("GeographicInfoTypesList"); // Return to list
                return;
            }
        }
