 ...
 * Page class
 */
class DisasterIncidentsDelete extends DisasterIncidents
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DisasterIncidentsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "DisasterIncidentsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("DisasterIncidentsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("DisasterIncidentsList"); // Return to list
                return;
            }
        }
