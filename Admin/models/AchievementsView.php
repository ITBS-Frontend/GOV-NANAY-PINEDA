 ...
 * Page class
 */
class AchievementsView extends Achievements
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AchievementsView";
    ...
    // CSS class/style
    public $CurrentPageName = "AchievementsView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "AchievementsList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "AchievementsList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
