 ...
 * Page class
 */
class ProjectGalleryAdd extends ProjectGallery
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProjectGalleryAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "ProjectGalleryAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("ProjectGalleryList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "ProjectGalleryView") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions && !$this->getCurrentMasterTable()) {
                        ...
                        if (GetPageName($returnUrl) != "ProjectGalleryList") {
                            ...
                            $returnUrl = "ProjectGalleryList"; // Return list page content
                        }
                    }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("ProjectGalleryList"), "", $this->TableVar, true);
