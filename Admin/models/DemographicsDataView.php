 ...
 * Page class
 */
class DemographicsDataView extends DemographicsData
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DemographicsDataView";
    ...
    // CSS class/style
    public $CurrentPageName = "DemographicsDataView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "DemographicsDataList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "DemographicsDataList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
