 ...
 * Page class
 */
class AboutContentDelete extends AboutContent
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AboutContentDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "AboutContentDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("AboutContentList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("AboutContentList"); // Return to list
                return;
            }
        }
