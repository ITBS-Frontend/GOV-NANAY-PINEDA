...
/**
 * Table class for tourism_categories
 */
class TourismCategories extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "tourism_categories";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "tourism_categories";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("TourismCategoriesList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "TourismCategoriesView" => $Language->phrase("View"),
            "TourismCategoriesEdit" => $Language->phrase("Edit"),
            "TourismCategoriesAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "TourismCategoriesView",
            Config("API_ADD_ACTION") => "TourismCategoriesAdd",
            Config("API_EDIT_ACTION") => "TourismCategoriesEdit",
            Config("API_DELETE_ACTION") => "TourismCategoriesDelete",
            Config("API_LIST_ACTION") => "TourismCategoriesList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("TourismCategoriesView", $parm);
        } else {
            $url = $this->keyUrl("TourismCategoriesView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "TourismCategoriesAdd?" . $parm;
        } else {
            $url = "TourismCategoriesAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TourismCategoriesEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TourismCategoriesList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TourismCategoriesAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TourismCategoriesList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("TourismCategoriesDelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "TourismCategoriesList";
