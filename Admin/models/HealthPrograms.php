...
/**
 * Table class for health_programs
 */
class HealthPrograms extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "health_programs";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->target_beneficiaries = new DbField(
            $this, // Table
            'x_target_beneficiaries', // Variable name
            'target_beneficiaries', // Name
            '"target_beneficiaries"', // Expression
            '"target_beneficiaries"', // Basic search expression
            200, // Type
            255, // Size
            -1, // Date/Time format
            false, // Is upload field
            '"target_beneficiaries"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->target_beneficiaries->InputTextType = "text";
        $this->target_beneficiaries->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['target_beneficiaries'] = &$this->target_beneficiaries;

        // coverage_area
        $this->coverage_area = new DbField(
            $this, // Table
            'x_coverage_area', // Variable name
            'coverage_area', // Name
            '"coverage_area"', // Expression
            '"coverage_area"', // Basic search expression
            200, // Type
            255, // Size
            -1, // Date/Time format
            false, // Is upload field
            '"coverage_area"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->coverage_area->InputTextType = "text";
        $this->coverage_area->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['coverage_area'] = &$this->coverage_area;

        // implementation_date
        $this->implementation_date = new DbField(
            $this, // Table
            'x_implementation_date', // Variable name
            'implementation_date', // Name
            '"implementation_date"', // Expression
            CastDateFieldForLike("\"implementation_date\"", 0, "DB"), // Basic search expression
            133, // Type
            0, // Size
            0, // Date/Time format
            false, // Is upload field
            '"implementation_date"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->implementation_date->InputTextType = "text";
        $this->implementation_date->Raw = true;
        $this->implementation_date->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
        ...
        $this->is_active->Lookup = new Lookup($this->is_active, 'health_programs', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "health_programs";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->target_beneficiaries->DbValue = $row['target_beneficiaries'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("HealthProgramsList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "HealthProgramsView" => $Language->phrase("View"),
            "HealthProgramsEdit" => $Language->phrase("Edit"),
            "HealthProgramsAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "HealthProgramsView",
            Config("API_ADD_ACTION") => "HealthProgramsAdd",
            Config("API_EDIT_ACTION") => "HealthProgramsEdit",
            Config("API_DELETE_ACTION") => "HealthProgramsDelete",
            Config("API_LIST_ACTION") => "HealthProgramsList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("HealthProgramsView", $parm);
        } else {
            $url = $this->keyUrl("HealthProgramsView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "HealthProgramsAdd?" . $parm;
        } else {
            $url = "HealthProgramsAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("HealthProgramsEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("HealthProgramsList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("HealthProgramsAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("HealthProgramsList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("HealthProgramsDelete", $parm);
        }
    }
    ...
    public function renderListRow()
    {
        ...
        if ($this->featured_image->UseColorbox) {
            ...
            $this->featured_image->LinkAttrs["data-rel"] = "health_programs_x_featured_image";
    ...
    public function renderEditRow()
    {
        ...
        $this->target_beneficiaries->EditValue = $this->target_beneficiaries->CurrentValue;
        ...
        $this->coverage_area->EditValue = $this->coverage_area->CurrentValue;
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->target_beneficiaries);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->target_beneficiaries);
