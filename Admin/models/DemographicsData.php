...
/**
 * Table class for demographics_data
 */
class DemographicsData extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "demographics_data";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->label->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "demographics_data";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("DemographicsDataList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "DemographicsDataView" => $Language->phrase("View"),
            "DemographicsDataEdit" => $Language->phrase("Edit"),
            "DemographicsDataAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "DemographicsDataView",
            Config("API_ADD_ACTION") => "DemographicsDataAdd",
            Config("API_EDIT_ACTION") => "DemographicsDataEdit",
            Config("API_DELETE_ACTION") => "DemographicsDataDelete",
            Config("API_LIST_ACTION") => "DemographicsDataList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("DemographicsDataView", $parm);
        } else {
            $url = $this->keyUrl("DemographicsDataView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "DemographicsDataAdd?" . $parm;
        } else {
            $url = "DemographicsDataAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DemographicsDataEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DemographicsDataList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DemographicsDataAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DemographicsDataList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("DemographicsDataDelete", $parm);
        }
    }
