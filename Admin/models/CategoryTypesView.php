 ...
 * Page class
 */
class CategoryTypesView extends CategoryTypes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CategoryTypesView";
    ...
    // CSS class/style
    public $CurrentPageName = "CategoryTypesView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "CategoryTypesList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "CategoryTypesList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
