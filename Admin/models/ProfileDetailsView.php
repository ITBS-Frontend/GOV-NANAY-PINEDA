 ...
 * Page class
 */
class ProfileDetailsView extends ProfileDetails
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProfileDetailsView";
    ...
    // CSS class/style
    public $CurrentPageName = "ProfileDetailsView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "ProfileDetailsList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ProfileDetailsList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
