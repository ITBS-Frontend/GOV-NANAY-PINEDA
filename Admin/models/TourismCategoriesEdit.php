 ...
 * Page class
 */
class TourismCategoriesEdit extends TourismCategories
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TourismCategoriesEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "TourismCategoriesEdit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("TourismCategoriesList"); // No matching record, return to list
                        return;
                    }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "TourismCategoriesList") {
                ...
                if ($this->editRow()) { // Update record based on key
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "TourismCategoriesList") {
                            ...
                            $returnUrl = "TourismCategoriesList"; // Return list page content
                        }
                    }
                    if (IsJsonResponse()) {
                        $this->terminate(true);
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("TourismCategoriesList"), "", $this->TableVar, true);
        $pageId = "edit";
