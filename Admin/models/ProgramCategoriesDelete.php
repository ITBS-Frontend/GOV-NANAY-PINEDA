 ...
 * Page class
 */
class ProgramCategoriesDelete extends ProgramCategories
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProgramCategoriesDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ProgramCategoriesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ProgramCategoriesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ProgramCategoriesList"); // Return to list
                return;
            }
        }
