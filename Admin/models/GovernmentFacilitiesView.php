 ...
 * Page class
 */
class GovernmentFacilitiesView extends GovernmentFacilities
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "GovernmentFacilitiesView";
    ...
    // CSS class/style
    public $CurrentPageName = "GovernmentFacilitiesView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "GovernmentFacilitiesList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "GovernmentFacilitiesList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
