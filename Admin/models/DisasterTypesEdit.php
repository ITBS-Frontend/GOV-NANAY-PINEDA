 ...
 * Page class
 */
class DisasterTypesEdit extends DisasterTypes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DisasterTypesEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "DisasterTypesEdit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("DisasterTypesList"); // No matching record, return to list
                        return;
                    }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "DisasterTypesList") {
                ...
                if ($this->editRow()) { // Update record based on key
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "DisasterTypesList") {
                            ...
                            $returnUrl = "DisasterTypesList"; // Return list page content
                        }
                    }
                    if (IsJsonResponse()) {
                        $this->terminate(true);
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("DisasterTypesList"), "", $this->TableVar, true);
        $pageId = "edit";
