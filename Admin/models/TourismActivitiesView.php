 ...
 * Page class
 */
class TourismActivitiesView extends TourismActivities
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TourismActivitiesView";
    ...
    // CSS class/style
    public $CurrentPageName = "TourismActivitiesView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "TourismActivitiesList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "TourismActivitiesList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
