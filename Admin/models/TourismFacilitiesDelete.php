 ...
 * Page class
 */
class TourismFacilitiesDelete extends TourismFacilities
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TourismFacilitiesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("TourismFacilitiesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("TourismFacilitiesList"); // Return to list
                return;
            }
        }
