 ...
 * Page class
 */
class NewsPostsList extends NewsPosts
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NewsPostsList";
    ...
    public $FormName = "fnews_postslist";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "NewsPostsList";
    ...
    public function __construct()
    {
        ...
        $this->MultiDeleteUrl = "NewsPostsDelete";
        $this->MultiUpdateUrl = "NewsPostsUpdate";
    ...
    public function getFilterList()
    {
        ...
        $filterList = Concat($filterList, $this->excerpt->AdvancedSearch->toJson(), ","); // Field excerpt
        ...
        $filterList = Concat($filterList, $this->author_name->AdvancedSearch->toJson(), ","); // Field author_name
        $filterList = Concat($filterList, $this->is_featured->AdvancedSearch->toJson(), ","); // Field is_featured
        $filterList = Concat($filterList, $this->is_published->AdvancedSearch->toJson(), ","); // Field is_published
        $filterList = Concat($filterList, $this->published_date->AdvancedSearch->toJson(), ","); // Field published_date
    ...
    protected function processFilterList()
    {
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            Profile()->setSearchFilters("fnews_postssrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field excerpt
        $this->excerpt->AdvancedSearch->SearchValue = @$filter["x_excerpt"];
        $this->excerpt->AdvancedSearch->SearchOperator = @$filter["z_excerpt"];
        $this->excerpt->AdvancedSearch->SearchCondition = @$filter["v_excerpt"];
        $this->excerpt->AdvancedSearch->SearchValue2 = @$filter["y_excerpt"];
        $this->excerpt->AdvancedSearch->SearchOperator2 = @$filter["w_excerpt"];
        $this->excerpt->AdvancedSearch->save();
        ...
        // Field author_name
        $this->author_name->AdvancedSearch->SearchValue = @$filter["x_author_name"];
        $this->author_name->AdvancedSearch->SearchOperator = @$filter["z_author_name"];
        $this->author_name->AdvancedSearch->SearchCondition = @$filter["v_author_name"];
        $this->author_name->AdvancedSearch->SearchValue2 = @$filter["y_author_name"];
        $this->author_name->AdvancedSearch->SearchOperator2 = @$filter["w_author_name"];
        $this->author_name->AdvancedSearch->save();
        ...
        // Field is_published
        $this->is_published->AdvancedSearch->SearchValue = @$filter["x_is_published"];
        $this->is_published->AdvancedSearch->SearchOperator = @$filter["z_is_published"];
        $this->is_published->AdvancedSearch->SearchCondition = @$filter["v_is_published"];
        $this->is_published->AdvancedSearch->SearchValue2 = @$filter["y_is_published"];
        $this->is_published->AdvancedSearch->SearchOperator2 = @$filter["w_is_published"];
        $this->is_published->AdvancedSearch->save();

        // Field published_date
        $this->published_date->AdvancedSearch->SearchValue = @$filter["x_published_date"];
        $this->published_date->AdvancedSearch->SearchOperator = @$filter["z_published_date"];
        $this->published_date->AdvancedSearch->SearchCondition = @$filter["v_published_date"];
        $this->published_date->AdvancedSearch->SearchValue2 = @$filter["y_published_date"];
        $this->published_date->AdvancedSearch->SearchOperator2 = @$filter["w_published_date"];
        $this->published_date->AdvancedSearch->save();

        // Field views_count
        $this->views_count->AdvancedSearch->SearchValue = @$filter["x_views_count"];
        $this->views_count->AdvancedSearch->SearchOperator = @$filter["z_views_count"];
        $this->views_count->AdvancedSearch->SearchCondition = @$filter["v_views_count"];
        $this->views_count->AdvancedSearch->SearchValue2 = @$filter["y_views_count"];
        $this->views_count->AdvancedSearch->SearchOperator2 = @$filter["w_views_count"];
        $this->views_count->AdvancedSearch->save();
        ...
        if ($this->CurrentMode == "view") {
            ...
            if ($Security->canView()) {
                if ($this->ModalView && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-view\" title=\"" . $viewcaption . "\" data-table=\"news_posts\" data-caption=\"" . $viewcaption . "\" data-ew-action=\"modal\" data-action=\"view\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->ViewUrl)) . "\" data-btn=\"null\">" . $Language->phrase("ViewLink") . "</a>";
                } else {
            ...
            if ($Security->canEdit()) {
                if ($this->ModalEdit && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-edit\" title=\"" . $editcaption . "\" data-table=\"news_posts\" data-caption=\"" . $editcaption . "\" data-ew-action=\"modal\" data-action=\"edit\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->EditUrl)) . "\" data-btn=\"SaveBtn\">" . $Language->phrase("EditLink") . "</a>";
                } else {
            ...
            if ($Security->canAdd()) {
                if ($this->ModalAdd && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-copy\" title=\"" . $copycaption . "\" data-table=\"news_posts\" data-caption=\"" . $copycaption . "\" data-ew-action=\"modal\" data-action=\"add\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->CopyUrl)) . "\" data-btn=\"AddBtn\">" . $Language->phrase("CopyLink") . "</a>";
                } else {
                ...
                if ($listAction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    if ($action != "") {
                        ...
                        $link = $disabled
                            ...
                            : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fnews_postslist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listAction->toDataAttributes() . ">" . $icon . " " . $caption . "</button></li>";
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = $disabled
                            ? "<div class=\"alert alert-light\">" . $icon . " " . $caption . "</div>"
                            : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . $title . "\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fnews_postslist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listAction->toDataAttributes() . ">" . $icon . " " . $caption . "</button>";
                        }
                    }
                }
            }
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->ModalAdd && !IsMobile()) {
            $item->Body = "<a class=\"ew-add-edit ew-add\" title=\"" . $addcaption . "\" data-table=\"news_posts\" data-caption=\"" . $addcaption . "\" data-ew-action=\"modal\" data-action=\"add\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->AddUrl)) . "\" data-btn=\"AddBtn\">" . $Language->phrase("AddLink") . "</a>";
        } else {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fnews_postssrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fnews_postssrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions as $listAction) {
            if ($listAction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="fnews_postslist"' . $listAction->toDataAttributes() . '>' . $icon . '</button>';
    ...
    public function setupRow()
    {
        ...
        if ($this->isGridAdd() || $this->isGridEdit()) {
            if ($this->RowIndex === '$rowindex$') { // Render template row first
                ...
                // Set row properties
                $this->resetAttributes();
                $this->RowAttrs->merge(["data-rowindex" => $this->RowIndex, "id" => "r0_news_posts", "data-rowtype" => RowType::ADD]);
        ...
        $this->RowAttrs->merge([
            ...
            "id" => "r" . $this->RowCount . "_news_posts",
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == RowType::VIEW) {
            ...
            if ($this->featured_image->UseColorbox) {
                ...
                $this->featured_image->LinkAttrs["data-rel"] = "news_posts_x" . $this->RowCount . "_featured_image";
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fnews_postssrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
