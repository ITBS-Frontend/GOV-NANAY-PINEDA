 ...
 * Page class
 */
class EnvironmentalProgramTypesView extends EnvironmentalProgramTypes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EnvironmentalProgramTypesView";
    ...
    // CSS class/style
    public $CurrentPageName = "EnvironmentalProgramTypesView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "EnvironmentalProgramTypesList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "EnvironmentalProgramTypesList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
