 ...
 * Page class
 */
class NewsPostTagsAdd extends NewsPostTags
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NewsPostTagsAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "NewsPostTagsAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "NewsPostTagsView") {
