 ...
 * Page class
 */
class NewsTagsView extends NewsTags
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NewsTagsView";
    ...
    // CSS class/style
    public $CurrentPageName = "NewsTagsView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "NewsTagsList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "NewsTagsList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
