 ...
 * Page class
 */
class OwnershipTypesView extends OwnershipTypes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "OwnershipTypesView";
    ...
    // CSS class/style
    public $CurrentPageName = "OwnershipTypesView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "OwnershipTypesList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "OwnershipTypesList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
