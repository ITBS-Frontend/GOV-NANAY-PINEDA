 ...
 * Page class
 */
class AchievementsAdd extends Achievements
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AchievementsAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "AchievementsAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "AchievementsView") {
