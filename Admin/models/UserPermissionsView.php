 ...
 * Page class
 */
class UserPermissionsView extends UserPermissions
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "UserPermissionsView";
    ...
    // CSS class/style
    public $CurrentPageName = "UserPermissionsView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("permission_id") ?? Route("permission_id")) !== null) {
            ...
            $returnUrl = "UserPermissionsList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "UserPermissionsList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
