 ...
 * Page class
 */
class FacilityTypesEdit extends FacilityTypes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FacilityTypesEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "FacilityTypesEdit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("FacilityTypesList"); // No matching record, return to list
                        return;
                    }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "FacilityTypesList") {
                ...
                if ($this->editRow()) { // Update record based on key
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "FacilityTypesList") {
                            ...
                            $returnUrl = "FacilityTypesList"; // Return list page content
                        }
                    }
                    if (IsJsonResponse()) {
                        $this->terminate(true);
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("FacilityTypesList"), "", $this->TableVar, true);
        $pageId = "edit";
