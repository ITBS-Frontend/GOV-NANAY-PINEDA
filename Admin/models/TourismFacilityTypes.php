...
/**
 * Table class for tourism_facility_types
 */
class TourismFacilityTypes extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "tourism_facility_types";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->is_active->Lookup = new Lookup($this->is_active, 'tourism_facility_types', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "tourism_facility_types";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("TourismFacilityTypesList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "TourismFacilityTypesView" => $Language->phrase("View"),
            "TourismFacilityTypesEdit" => $Language->phrase("Edit"),
            "TourismFacilityTypesAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    {
        return "TourismFacilityTypesList";
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "TourismFacilityTypesView",
            Config("API_ADD_ACTION") => "TourismFacilityTypesAdd",
            Config("API_EDIT_ACTION") => "TourismFacilityTypesEdit",
            Config("API_DELETE_ACTION") => "TourismFacilityTypesDelete",
            Config("API_LIST_ACTION") => "TourismFacilityTypesList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("TourismFacilityTypesView", $parm);
        } else {
            $url = $this->keyUrl("TourismFacilityTypesView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "TourismFacilityTypesAdd?" . $parm;
        } else {
            $url = "TourismFacilityTypesAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TourismFacilityTypesEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TourismFacilityTypesList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TourismFacilityTypesAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TourismFacilityTypesList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("TourismFacilityTypesDelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "TourismFacilityTypesList";
