 ...
 * Page class
 */
class GeographicInfoAdd extends GeographicInfo
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "GeographicInfoAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "GeographicInfoAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("GeographicInfoList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "GeographicInfoList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "GeographicInfoView") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "GeographicInfoList") {
                            ...
                            $returnUrl = "GeographicInfoList"; // Return list page content
                        }
                    }
    ...
    protected function getAddRow()
    {
        ...
        // info_type_id
        $this->info_type_id->setDbValueDef($rsnew, $this->info_type_id->CurrentValue, false);
        return $rsnew;
    }
    ...
    protected function restoreAddFormFromRow($row)
    {
        ...
        if (isset($row['info_type_id'])) { // info_type_id
            $this->info_type_id->setFormValue($row['info_type_id']);
        }
    }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("GeographicInfoList"), "", $this->TableVar, true);
