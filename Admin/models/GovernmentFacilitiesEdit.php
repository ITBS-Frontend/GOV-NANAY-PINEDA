 ...
 * Page class
 */
class GovernmentFacilitiesEdit extends GovernmentFacilities
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "GovernmentFacilitiesEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "GovernmentFacilitiesEdit";
    ...
    public function setVisibility()
    {
        ...
        $this->services_offered->setVisibility();
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("GovernmentFacilitiesList"); // No matching record, return to list
                        return;
                    }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "GovernmentFacilitiesList") {
                ...
                if ($this->editRow()) { // Update record based on key
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "GovernmentFacilitiesList") {
                            ...
                            $returnUrl = "GovernmentFacilitiesList"; // Return list page content
                        }
                    }
                    if (IsJsonResponse()) {
                        $this->terminate(true);
    ...
    protected function loadFormValues()
    {
        ...
        // Check field name 'services_offered' first before field var 'x_services_offered'
        $val = $CurrentForm->hasValue("services_offered") ? $CurrentForm->getValue("services_offered") : $CurrentForm->getValue("x_services_offered");
        if (!$this->services_offered->IsDetailKey) {
            if (IsApi() && $val === null) {
                $this->services_offered->Visible = false; // Disable update for API request
            } else {
                $this->services_offered->setFormValue($val);
            }
        }
    ...
    public function restoreFormValues()
    {
        ...
        $this->services_offered->CurrentValue = $this->services_offered->FormValue;
    ...
    public function renderRow()
    {
        ...
        // services_offered
        $this->services_offered->RowCssClass = "row";
        ...
        if ($this->RowType == RowType::VIEW) {
            ...
            // services_offered
            $this->services_offered->ViewValue = $this->services_offered->CurrentValue;
            ...
            // services_offered
            $this->services_offered->HrefValue = "";
            ...
            // services_offered
            $this->services_offered->setupEditAttributes();
            $this->services_offered->EditValue = HtmlEncode($this->services_offered->CurrentValue);
            $this->services_offered->PlaceHolder = RemoveHtml($this->services_offered->caption());
    ...
    protected function validateForm()
    {
        ...
        $validateForm = true;
            ...
            if ($this->services_offered->Visible && $this->services_offered->Required) {
                if (!$this->services_offered->IsDetailKey && EmptyValue($this->services_offered->FormValue)) {
                    $this->services_offered->addErrorMessage(str_replace("%s", $this->services_offered->caption(), $this->services_offered->RequiredErrorMessage));
                }
            }
    ...
    protected function getEditRow($rsold)
    {
        ...
        // operating_hours
        $this->operating_hours->setDbValueDef($rsnew, $this->operating_hours->CurrentValue, $this->operating_hours->ReadOnly);

        // services_offered
        $this->services_offered->setDbValueDef($rsnew, $this->services_offered->CurrentValue, $this->services_offered->ReadOnly);
    ...
    protected function restoreEditFormFromRow($row)
    {
        ...
        if (isset($row['operating_hours'])) { // operating_hours
            $this->operating_hours->CurrentValue = $row['operating_hours'];
        }
        if (isset($row['services_offered'])) { // services_offered
            $this->services_offered->CurrentValue = $row['services_offered'];
        }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("GovernmentFacilitiesList"), "", $this->TableVar, true);
        $pageId = "edit";
