 ...
 * Page class
 */
class ProvinceHistoryDelete extends ProvinceHistory
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProvinceHistoryDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ProvinceHistoryDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ProvinceHistoryList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ProvinceHistoryList"); // Return to list
                return;
            }
        }
