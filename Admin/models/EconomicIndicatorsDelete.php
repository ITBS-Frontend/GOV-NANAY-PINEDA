 ...
 * Page class
 */
class EconomicIndicatorsDelete extends EconomicIndicators
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EconomicIndicatorsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "EconomicIndicatorsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("EconomicIndicatorsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("EconomicIndicatorsList"); // Return to list
                return;
            }
        }
