 ...
 * Page class
 */
class EnvironmentalProgramsView extends EnvironmentalPrograms
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EnvironmentalProgramsView";
    ...
    // CSS class/style
    public $CurrentPageName = "EnvironmentalProgramsView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "EnvironmentalProgramsList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "EnvironmentalProgramsList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
