 ...
 * Page class
 */
class HealthProgramsView extends HealthPrograms
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "HealthProgramsView";
    ...
    // CSS class/style
    public $CurrentPageName = "HealthProgramsView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "HealthProgramsList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "HealthProgramsList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
