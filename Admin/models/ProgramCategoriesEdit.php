 ...
 * Page class
 */
class ProgramCategoriesEdit extends ProgramCategories
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProgramCategoriesEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "ProgramCategoriesEdit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("ProgramCategoriesList"); // No matching record, return to list
                        return;
                    }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "ProgramCategoriesList") {
                ...
                if ($this->editRow()) { // Update record based on key
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "ProgramCategoriesList") {
                            ...
                            $returnUrl = "ProgramCategoriesList"; // Return list page content
                        }
                    }
                    if (IsJsonResponse()) {
                        $this->terminate(true);
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("ProgramCategoriesList"), "", $this->TableVar, true);
        $pageId = "edit";
