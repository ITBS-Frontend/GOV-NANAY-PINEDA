 ...
 * Page class
 */
class TourismCategoriesView extends TourismCategories
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TourismCategoriesView";
    ...
    // CSS class/style
    public $CurrentPageName = "TourismCategoriesView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "TourismCategoriesList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "TourismCategoriesList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
