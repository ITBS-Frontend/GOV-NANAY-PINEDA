...
/**
 * Table class for project_gallery
 */
class ProjectGallery extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "project_gallery";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->project_id->IsForeignKey = true; // Foreign key field
        ...
        $this->caption = new DbField(
            $this, // Table
            'x_caption', // Variable name
            'caption', // Name
            '"caption"', // Expression
            '"caption"', // Basic search expression
            200, // Type
            255, // Size
            -1, // Date/Time format
            false, // Is upload field
            '"caption"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->caption->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
    ...
    public function getMasterFilterFromSession()
    {
        ...
        if ($this->getCurrentMasterTable() == "projects") {
            $masterTable = Container("projects");
            if ($this->project_id->getSessionValue() != "") {
                $masterFilter .= "" . GetKeyFilter($masterTable->id, $this->project_id->getSessionValue(), $masterTable->id->DataType, $masterTable->Dbid);
            } else {
                return "";
            }
        }
    ...
    public function getDetailFilterFromSession()
    {
        ...
        if ($this->getCurrentMasterTable() == "projects") {
            $masterTable = Container("projects");
            if ($this->project_id->getSessionValue() != "") {
                $detailFilter .= "" . GetKeyFilter($this->project_id, $this->project_id->getSessionValue(), $masterTable->id->DataType, $this->Dbid);
            } else {
                return "";
            }
        }
    ...
    public function getMasterFilter($masterTable, $keys)
    {
        ...
        switch ($masterTable->TableVar) {
            case "projects":
                ...
                if ($validKeys) {
                    return GetKeyFilter($masterTable->id, $keys["project_id"], $this->project_id->DataType, $this->Dbid);
                }
                break;
        }
    ...
    public function getDetailFilter($masterTable)
    {
        switch ($masterTable->TableVar) {
            case "projects":
                return GetKeyFilter($this->project_id, $masterTable->id->DbValue, $masterTable->id->DataType, $masterTable->Dbid);
        }
        return "";
    }
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "project_gallery";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ProjectGalleryList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "ProjectGalleryView" => $Language->phrase("View"),
            "ProjectGalleryEdit" => $Language->phrase("Edit"),
            "ProjectGalleryAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ProjectGalleryView",
            Config("API_ADD_ACTION") => "ProjectGalleryAdd",
            Config("API_EDIT_ACTION") => "ProjectGalleryEdit",
            Config("API_DELETE_ACTION") => "ProjectGalleryDelete",
            Config("API_LIST_ACTION") => "ProjectGalleryList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ProjectGalleryView", $parm);
        } else {
            $url = $this->keyUrl("ProjectGalleryView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "ProjectGalleryAdd?" . $parm;
        } else {
            $url = "ProjectGalleryAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ProjectGalleryEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ProjectGalleryList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ProjectGalleryAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ProjectGalleryList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ProjectGalleryDelete", $parm);
        }
    }
    ...
    {
        if ($this->getCurrentMasterTable() == "projects" && !ContainsString($url, Config("TABLE_SHOW_MASTER") . "=")) {
            $url .= (ContainsString($url, "?") ? "&" : "?") . Config("TABLE_SHOW_MASTER") . "=" . $this->getCurrentMasterTable();
            $url .= "&" . GetForeignKeyUrl("fk_id", $this->project_id->getSessionValue()); // Use Session Value
        }
        return $url;
    }
    ...
    public function renderListRow()
    {
        ...
        if ($this->image_path->UseColorbox) {
            ...
            $this->image_path->LinkAttrs["data-rel"] = "project_gallery_x_image_path";
