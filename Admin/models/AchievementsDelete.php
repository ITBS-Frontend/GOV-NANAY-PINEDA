 ...
 * Page class
 */
class AchievementsDelete extends Achievements
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AchievementsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "AchievementsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("AchievementsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("AchievementsList"); // Return to list
                return;
            }
        }
