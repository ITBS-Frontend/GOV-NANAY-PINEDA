...
/**
 * Table class for disaster_preparedness
 */
class DisasterPreparedness extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "disaster_preparedness";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->preparedness_guide = new DbField(
            $this, // Table
            'x_preparedness_guide', // Variable name
            'preparedness_guide', // Name
            '"preparedness_guide"', // Expression
            '"preparedness_guide"', // Basic search expression
            201, // Type
            0, // Size
            -1, // Date/Time format
            false, // Is upload field
            '"preparedness_guide"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->preparedness_guide->InputTextType = "text";
        $this->preparedness_guide->Nullable = false; // NOT NULL field
        $this->preparedness_guide->Required = true; // Required field
        $this->preparedness_guide->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
        $this->Fields['preparedness_guide'] = &$this->preparedness_guide;

        // emergency_hotlines
        $this->emergency_hotlines = new DbField(
            $this, // Table
            'x_emergency_hotlines', // Variable name
            'emergency_hotlines', // Name
            '"emergency_hotlines"', // Expression
            '"emergency_hotlines"', // Basic search expression
            201, // Type
            0, // Size
            -1, // Date/Time format
            false, // Is upload field
            '"emergency_hotlines"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->emergency_hotlines->InputTextType = "text";
        $this->emergency_hotlines->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['emergency_hotlines'] = &$this->emergency_hotlines;

        // evacuation_centers
        $this->evacuation_centers = new DbField(
            $this, // Table
            'x_evacuation_centers', // Variable name
            'evacuation_centers', // Name
            '"evacuation_centers"', // Expression
            '"evacuation_centers"', // Basic search expression
            201, // Type
            0, // Size
            -1, // Date/Time format
            false, // Is upload field
            '"evacuation_centers"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->evacuation_centers->InputTextType = "text";
        $this->evacuation_centers->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['evacuation_centers'] = &$this->evacuation_centers;

        // relief_procedures
        $this->relief_procedures = new DbField(
            $this, // Table
            'x_relief_procedures', // Variable name
            'relief_procedures', // Name
            '"relief_procedures"', // Expression
            '"relief_procedures"', // Basic search expression
            201, // Type
            0, // Size
            -1, // Date/Time format
            false, // Is upload field
            '"relief_procedures"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->relief_procedures->InputTextType = "text";
        $this->relief_procedures->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['relief_procedures'] = &$this->relief_procedures;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "disaster_preparedness";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("DisasterPreparednessList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "DisasterPreparednessView" => $Language->phrase("View"),
            "DisasterPreparednessEdit" => $Language->phrase("Edit"),
            "DisasterPreparednessAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    {
        return "DisasterPreparednessList";
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "DisasterPreparednessView",
            Config("API_ADD_ACTION") => "DisasterPreparednessAdd",
            Config("API_EDIT_ACTION") => "DisasterPreparednessEdit",
            Config("API_DELETE_ACTION") => "DisasterPreparednessDelete",
            Config("API_LIST_ACTION") => "DisasterPreparednessList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("DisasterPreparednessView", $parm);
        } else {
            $url = $this->keyUrl("DisasterPreparednessView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "DisasterPreparednessAdd?" . $parm;
        } else {
            $url = "DisasterPreparednessAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DisasterPreparednessEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DisasterPreparednessList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DisasterPreparednessAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DisasterPreparednessList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("DisasterPreparednessDelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "DisasterPreparednessList";
    ...
    public function renderListRow()
    {
        ...
        $this->preparedness_guide->TooltipValue = "";

        // emergency_hotlines
        $this->emergency_hotlines->HrefValue = "";
        $this->emergency_hotlines->TooltipValue = "";

        // evacuation_centers
        $this->evacuation_centers->HrefValue = "";
        $this->evacuation_centers->TooltipValue = "";
    ...
    public function renderEditRow()
    {
        ...
        $this->preparedness_guide->EditValue = $this->preparedness_guide->CurrentValue;
        ...
        $this->emergency_hotlines->EditValue = $this->emergency_hotlines->CurrentValue;
        ...
        $this->evacuation_centers->EditValue = $this->evacuation_centers->CurrentValue;
        $this->evacuation_centers->PlaceHolder = RemoveHtml($this->evacuation_centers->caption());

        // relief_procedures
        $this->relief_procedures->setupEditAttributes();
        $this->relief_procedures->EditValue = $this->relief_procedures->CurrentValue;
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->relief_procedures);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->relief_procedures);
