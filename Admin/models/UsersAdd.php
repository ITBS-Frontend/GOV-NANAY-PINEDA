...
class UsersAdd extends Users
{
    ...
    {
        $this->user_level_id->DefaultValue = $this->user_level_id->getDefault(); // PHP
        $this->user_level_id->OldValue = $this->user_level_id->DefaultValue;
    }
    ...
    public function loadRowValues($row = null)
    {
        ...
        $this->activated->setDbValue((ConvertToBool($row['activated']) ? "1" : "0"));
    ...
    protected function validateForm()
    {
        ...
        $validateForm = true;
            ...
            if ($this->user_level_id->Visible && $this->user_level_id->Required) {
                if ($Security->canAdmin() && !$this->user_level_id->IsDetailKey && EmptyValue($this->user_level_id->FormValue)) {
    ...
    protected function getAddRow()
    {
        ...
        // user_level_id
        if ($Security->canAdmin()) { // System admin
            $this->user_level_id->setDbValueDef($rsnew, $this->user_level_id->CurrentValue, strval($this->user_level_id->CurrentValue) == "");
        }
