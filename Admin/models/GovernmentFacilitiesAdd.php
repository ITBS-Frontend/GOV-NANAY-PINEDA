 ...
 * Page class
 */
class GovernmentFacilitiesAdd extends GovernmentFacilities
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "GovernmentFacilitiesAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "GovernmentFacilitiesAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "GovernmentFacilitiesView") {
    ...
    protected function getAddRow()
    {
        ...
        // services_offered
        $this->services_offered->setDbValueDef($rsnew, $this->services_offered->CurrentValue, false);
    ...
    protected function restoreAddFormFromRow($row)
    {
        ...
        if (isset($row['services_offered'])) { // services_offered
            $this->services_offered->setFormValue($row['services_offered']);
        }
