 ...
 * Page class
 */
class EnvironmentalProgramsEdit extends EnvironmentalPrograms
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EnvironmentalProgramsEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "EnvironmentalProgramsEdit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("EnvironmentalProgramsList"); // No matching record, return to list
                        return;
                    }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "EnvironmentalProgramsList") {
                ...
                if ($this->editRow()) { // Update record based on key
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "EnvironmentalProgramsList") {
                            ...
                            $returnUrl = "EnvironmentalProgramsList"; // Return list page content
                        }
                    }
                    if (IsJsonResponse()) {
                        $this->terminate(true);
    ...
    protected function getEditRow($rsold)
    {
        ...
        // coverage_area
        $this->coverage_area->setDbValueDef($rsnew, $this->coverage_area->CurrentValue, $this->coverage_area->ReadOnly);

        // implementation_date
        $this->implementation_date->setDbValueDef($rsnew, UnFormatDateTime($this->implementation_date->CurrentValue, $this->implementation_date->formatPattern()), $this->implementation_date->ReadOnly);
    ...
    protected function restoreEditFormFromRow($row)
    {
        ...
        if (isset($row['coverage_area'])) { // coverage_area
            $this->coverage_area->CurrentValue = $row['coverage_area'];
        }
        if (isset($row['implementation_date'])) { // implementation_date
            $this->implementation_date->CurrentValue = $row['implementation_date'];
        }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("EnvironmentalProgramsList"), "", $this->TableVar, true);
        $pageId = "edit";
