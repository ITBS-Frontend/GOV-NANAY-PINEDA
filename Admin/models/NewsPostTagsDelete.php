 ...
 * Page class
 */
class NewsPostTagsDelete extends NewsPostTags
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NewsPostTagsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "NewsPostTagsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("NewsPostTagsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("NewsPostTagsList"); // Return to list
                return;
            }
        }
