 ...
 * Page class
 */
class TourismCategoriesAdd extends TourismCategories
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TourismCategoriesAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "TourismCategoriesAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "TourismCategoriesView") {
