 ...
 * Page class
 */
class ProjectTypesAdd extends ProjectTypes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProjectTypesAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "ProjectTypesAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "ProjectTypesView") {
    ...
    protected function getAddRow()
    {
        ...
        // color_code
        $this->color_code->setDbValueDef($rsnew, $this->color_code->CurrentValue, strval($this->color_code->CurrentValue) == "");
