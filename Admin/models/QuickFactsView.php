 ...
 * Page class
 */
class QuickFactsView extends QuickFacts
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "QuickFactsView";
    ...
    // CSS class/style
    public $CurrentPageName = "QuickFactsView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "QuickFactsList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "QuickFactsList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
