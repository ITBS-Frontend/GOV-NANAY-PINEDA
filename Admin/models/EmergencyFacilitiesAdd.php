 ...
 * Page class
 */
class EmergencyFacilitiesAdd extends EmergencyFacilities
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmergencyFacilitiesAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "EmergencyFacilitiesAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "EmergencyFacilitiesView") {
    ...
    protected function restoreAddFormFromRow($row)
    {
        ...
        if (isset($row['capacity'])) { // capacity
            $this->capacity->setFormValue($row['capacity']);
        }
