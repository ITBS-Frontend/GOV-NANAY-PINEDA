 ...
 * Page class
 */
class EmergencyFacilityTypesAdd extends EmergencyFacilityTypes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmergencyFacilityTypesAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "EmergencyFacilityTypesAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "EmergencyFacilityTypesView") {
