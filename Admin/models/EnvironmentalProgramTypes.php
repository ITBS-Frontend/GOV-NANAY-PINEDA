...
/**
 * Table class for environmental_program_types
 */
class EnvironmentalProgramTypes extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "environmental_program_types";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->is_active->Lookup = new Lookup($this->is_active, 'environmental_program_types', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "environmental_program_types";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("EnvironmentalProgramTypesList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "EnvironmentalProgramTypesView" => $Language->phrase("View"),
            "EnvironmentalProgramTypesEdit" => $Language->phrase("Edit"),
            "EnvironmentalProgramTypesAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    {
        return "EnvironmentalProgramTypesList";
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "EnvironmentalProgramTypesView",
            Config("API_ADD_ACTION") => "EnvironmentalProgramTypesAdd",
            Config("API_EDIT_ACTION") => "EnvironmentalProgramTypesEdit",
            Config("API_DELETE_ACTION") => "EnvironmentalProgramTypesDelete",
            Config("API_LIST_ACTION") => "EnvironmentalProgramTypesList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("EnvironmentalProgramTypesView", $parm);
        } else {
            $url = $this->keyUrl("EnvironmentalProgramTypesView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "EnvironmentalProgramTypesAdd?" . $parm;
        } else {
            $url = "EnvironmentalProgramTypesAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("EnvironmentalProgramTypesEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("EnvironmentalProgramTypesList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("EnvironmentalProgramTypesAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("EnvironmentalProgramTypesList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("EnvironmentalProgramTypesDelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "EnvironmentalProgramTypesList";
