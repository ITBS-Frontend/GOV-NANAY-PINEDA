 ...
 * Page class
 */
class EconomicIndicatorsView extends EconomicIndicators
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EconomicIndicatorsView";
    ...
    // CSS class/style
    public $CurrentPageName = "EconomicIndicatorsView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "EconomicIndicatorsList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "EconomicIndicatorsList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
