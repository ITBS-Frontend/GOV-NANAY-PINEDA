 ...
 * Page class
 */
class EnvironmentalProgramsDelete extends EnvironmentalPrograms
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EnvironmentalProgramsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "EnvironmentalProgramsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("EnvironmentalProgramsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("EnvironmentalProgramsList"); // Return to list
                return;
            }
        }
