 ...
 * Page class
 */
class ProjectHighlightsDelete extends ProjectHighlights
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProjectHighlightsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ProjectHighlightsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ProjectHighlightsList"); // Return to list
                return;
            }
        }
