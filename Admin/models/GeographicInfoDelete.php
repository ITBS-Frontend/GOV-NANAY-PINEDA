 ...
 * Page class
 */
class GeographicInfoDelete extends GeographicInfo
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "GeographicInfoDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "GeographicInfoDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("GeographicInfoList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("GeographicInfoList"); // Return to list
                return;
            }
        }
