 ...
 * Page class
 */
class GeographicInfoTypesView extends GeographicInfoTypes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "GeographicInfoTypesView";
    ...
    // CSS class/style
    public $CurrentPageName = "GeographicInfoTypesView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "GeographicInfoTypesList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "GeographicInfoTypesList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
