...
/**
 * Table class for tourism_activities
 */
class TourismActivities extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "tourism_activities";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // activity_name
        $this->activity_name = new DbField(
            $this, // Table
            'x_activity_name', // Variable name
            'activity_name', // Name
            '"activity_name"', // Expression
            '"activity_name"', // Basic search expression
            200, // Type
            255, // Size
            -1, // Date/Time format
            false, // Is upload field
            '"activity_name"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->activity_name->InputTextType = "text";
        $this->activity_name->Nullable = false; // NOT NULL field
        $this->activity_name->Required = true; // Required field
        $this->activity_name->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "tourism_activities";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("TourismActivitiesList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "TourismActivitiesView" => $Language->phrase("View"),
            "TourismActivitiesEdit" => $Language->phrase("Edit"),
            "TourismActivitiesAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "TourismActivitiesView",
            Config("API_ADD_ACTION") => "TourismActivitiesAdd",
            Config("API_EDIT_ACTION") => "TourismActivitiesEdit",
            Config("API_DELETE_ACTION") => "TourismActivitiesDelete",
            Config("API_LIST_ACTION") => "TourismActivitiesList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("TourismActivitiesView", $parm);
        } else {
            $url = $this->keyUrl("TourismActivitiesView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "TourismActivitiesAdd?" . $parm;
        } else {
            $url = "TourismActivitiesAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TourismActivitiesEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TourismActivitiesList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TourismActivitiesAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TourismActivitiesList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("TourismActivitiesDelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "TourismActivitiesList";
