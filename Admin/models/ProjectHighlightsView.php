 ...
 * Page class
 */
class ProjectHighlightsView extends ProjectHighlights
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProjectHighlightsView";
    ...
    // CSS class/style
    public $CurrentPageName = "ProjectHighlightsView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "ProjectHighlightsList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ProjectHighlightsList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
