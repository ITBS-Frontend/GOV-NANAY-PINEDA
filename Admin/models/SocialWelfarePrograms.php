...
/**
 * Table class for social_welfare_programs
 */
class SocialWelfarePrograms extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "social_welfare_programs";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // program_name
        $this->program_name = new DbField(
            $this, // Table
            'x_program_name', // Variable name
            'program_name', // Name
            '"program_name"', // Expression
            '"program_name"', // Basic search expression
            200, // Type
            255, // Size
            -1, // Date/Time format
            false, // Is upload field
            '"program_name"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->program_name->InputTextType = "text";
        $this->program_name->Nullable = false; // NOT NULL field
        $this->program_name->Required = true; // Required field
        ...
        $this->eligibility_criteria = new DbField(
            $this, // Table
            'x_eligibility_criteria', // Variable name
            'eligibility_criteria', // Name
            '"eligibility_criteria"', // Expression
            '"eligibility_criteria"', // Basic search expression
            201, // Type
            0, // Size
            -1, // Date/Time format
            false, // Is upload field
            '"eligibility_criteria"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->eligibility_criteria->InputTextType = "text";
        $this->eligibility_criteria->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['eligibility_criteria'] = &$this->eligibility_criteria;

        // benefits
        $this->benefits = new DbField(
            $this, // Table
            'x_benefits', // Variable name
            'benefits', // Name
            '"benefits"', // Expression
            '"benefits"', // Basic search expression
            201, // Type
            0, // Size
            -1, // Date/Time format
            false, // Is upload field
            '"benefits"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->benefits->InputTextType = "text";
        $this->benefits->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['benefits'] = &$this->benefits;

        // how_to_apply
        $this->how_to_apply = new DbField(
            $this, // Table
            'x_how_to_apply', // Variable name
            'how_to_apply', // Name
            '"how_to_apply"', // Expression
            '"how_to_apply"', // Basic search expression
            201, // Type
            0, // Size
            -1, // Date/Time format
            false, // Is upload field
            '"how_to_apply"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->how_to_apply->InputTextType = "text";
        $this->how_to_apply->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['how_to_apply'] = &$this->how_to_apply;

        // required_documents
        $this->required_documents = new DbField(
            $this, // Table
            'x_required_documents', // Variable name
            'required_documents', // Name
            '"required_documents"', // Expression
            '"required_documents"', // Basic search expression
            201, // Type
            0, // Size
            -1, // Date/Time format
            false, // Is upload field
            '"required_documents"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->required_documents->InputTextType = "text";
        $this->required_documents->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['required_documents'] = &$this->required_documents;
        ...
        $this->is_active->Lookup = new Lookup($this->is_active, 'social_welfare_programs', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "social_welfare_programs";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->eligibility_criteria->DbValue = $row['eligibility_criteria'];
        $this->benefits->DbValue = $row['benefits'];
        $this->how_to_apply->DbValue = $row['how_to_apply'];
        $this->required_documents->DbValue = $row['required_documents'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("SocialWelfareProgramsList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "SocialWelfareProgramsView" => $Language->phrase("View"),
            "SocialWelfareProgramsEdit" => $Language->phrase("Edit"),
            "SocialWelfareProgramsAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    {
        return "SocialWelfareProgramsList";
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "SocialWelfareProgramsView",
            Config("API_ADD_ACTION") => "SocialWelfareProgramsAdd",
            Config("API_EDIT_ACTION") => "SocialWelfareProgramsEdit",
            Config("API_DELETE_ACTION") => "SocialWelfareProgramsDelete",
            Config("API_LIST_ACTION") => "SocialWelfareProgramsList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("SocialWelfareProgramsView", $parm);
        } else {
            $url = $this->keyUrl("SocialWelfareProgramsView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "SocialWelfareProgramsAdd?" . $parm;
        } else {
            $url = "SocialWelfareProgramsAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("SocialWelfareProgramsEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("SocialWelfareProgramsList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("SocialWelfareProgramsAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("SocialWelfareProgramsList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("SocialWelfareProgramsDelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "SocialWelfareProgramsList";
    ...
    public function renderListRow()
    {
        ...
        $this->eligibility_criteria->TooltipValue = "";
        ...
        $this->how_to_apply->TooltipValue = "";

        // required_documents
        $this->required_documents->HrefValue = "";
        $this->required_documents->TooltipValue = "";
    ...
    public function renderEditRow()
    {
        ...
        $this->eligibility_criteria->EditValue = $this->eligibility_criteria->CurrentValue;
        ...
        $this->how_to_apply->EditValue = $this->how_to_apply->CurrentValue;
        $this->how_to_apply->PlaceHolder = RemoveHtml($this->how_to_apply->caption());

        // required_documents
        $this->required_documents->setupEditAttributes();
        $this->required_documents->EditValue = $this->required_documents->CurrentValue;
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->eligibility_criteria);
                    $doc->exportCaption($this->benefits);
                    $doc->exportCaption($this->how_to_apply);
                    $doc->exportCaption($this->required_documents);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->eligibility_criteria);
                        $doc->exportField($this->benefits);
                        $doc->exportField($this->how_to_apply);
                        $doc->exportField($this->required_documents);
