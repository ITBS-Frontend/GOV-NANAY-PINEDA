 ...
 * Page class
 */
class DestinationGalleryDelete extends DestinationGallery
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DestinationGalleryDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "DestinationGalleryDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("DestinationGalleryList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("DestinationGalleryList"); // Return to list
                return;
            }
        }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("DestinationGalleryList"), "", $this->TableVar, true);
        $pageId = "delete";
