...
/**
 * Table class for disaster_incidents
 */
class DisasterIncidents extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "disaster_incidents";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->incident_name = new DbField(
            $this, // Table
            'x_incident_name', // Variable name
            'incident_name', // Name
            '"incident_name"', // Expression
            '"incident_name"', // Basic search expression
            200, // Type
            255, // Size
            -1, // Date/Time format
            false, // Is upload field
            '"incident_name"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->incident_name->InputTextType = "text";
        $this->incident_name->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['incident_name'] = &$this->incident_name;

        // occurrence_date
        $this->occurrence_date = new DbField(
            $this, // Table
            'x_occurrence_date', // Variable name
            'occurrence_date', // Name
            '"occurrence_date"', // Expression
            CastDateFieldForLike("\"occurrence_date\"", 0, "DB"), // Basic search expression
            133, // Type
            0, // Size
            0, // Date/Time format
            false, // Is upload field
            '"occurrence_date"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->occurrence_date->InputTextType = "text";
        $this->occurrence_date->Raw = true;
        $this->occurrence_date->Nullable = false; // NOT NULL field
        $this->occurrence_date->Required = true; // Required field
        $this->occurrence_date->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
        $this->occurrence_date->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        $this->Fields['occurrence_date'] = &$this->occurrence_date;

        // affected_areas
        $this->affected_areas = new DbField(
            $this, // Table
            'x_affected_areas', // Variable name
            'affected_areas', // Name
            '"affected_areas"', // Expression
            '"affected_areas"', // Basic search expression
            201, // Type
            0, // Size
            -1, // Date/Time format
            false, // Is upload field
            '"affected_areas"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->affected_areas->InputTextType = "text";
        $this->affected_areas->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['affected_areas'] = &$this->affected_areas;

        // casualties
        $this->casualties = new DbField(
            $this, // Table
            'x_casualties', // Variable name
            'casualties', // Name
            '"casualties"', // Expression
            'CAST("casualties" AS varchar(255))', // Basic search expression
            3, // Type
            0, // Size
            -1, // Date/Time format
            false, // Is upload field
            '"casualties"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->casualties->addMethod("getDefault", fn() => 0);
        $this->casualties->InputTextType = "text";
        $this->casualties->Raw = true;
        $this->casualties->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->casualties->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        $this->Fields['casualties'] = &$this->casualties;

        // damages_estimated
        $this->damages_estimated = new DbField(
            $this, // Table
            'x_damages_estimated', // Variable name
            'damages_estimated', // Name
            '"damages_estimated"', // Expression
            'CAST("damages_estimated" AS varchar(255))', // Basic search expression
            14, // Type
            0, // Size
            -1, // Date/Time format
            false, // Is upload field
            '"damages_estimated"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->damages_estimated->InputTextType = "text";
        $this->damages_estimated->Raw = true;
        $this->damages_estimated->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->damages_estimated->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        $this->Fields['damages_estimated'] = &$this->damages_estimated;

        // response_actions
        $this->response_actions = new DbField(
            $this, // Table
            'x_response_actions', // Variable name
            'response_actions', // Name
            '"response_actions"', // Expression
            '"response_actions"', // Basic search expression
            201, // Type
            0, // Size
            -1, // Date/Time format
            false, // Is upload field
            '"response_actions"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->response_actions->InputTextType = "text";
        $this->response_actions->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['response_actions'] = &$this->response_actions;

        // lessons_learned
        $this->lessons_learned = new DbField(
            $this, // Table
            'x_lessons_learned', // Variable name
            'lessons_learned', // Name
            '"lessons_learned"', // Expression
            '"lessons_learned"', // Basic search expression
            201, // Type
            0, // Size
            -1, // Date/Time format
            false, // Is upload field
            '"lessons_learned"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->lessons_learned->InputTextType = "text";
        $this->lessons_learned->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['lessons_learned'] = &$this->lessons_learned;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "disaster_incidents";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->casualties->DbValue = $row['casualties'];
        $this->damages_estimated->DbValue = $row['damages_estimated'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("DisasterIncidentsList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "DisasterIncidentsView" => $Language->phrase("View"),
            "DisasterIncidentsEdit" => $Language->phrase("Edit"),
            "DisasterIncidentsAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "DisasterIncidentsView",
            Config("API_ADD_ACTION") => "DisasterIncidentsAdd",
            Config("API_EDIT_ACTION") => "DisasterIncidentsEdit",
            Config("API_DELETE_ACTION") => "DisasterIncidentsDelete",
            Config("API_LIST_ACTION") => "DisasterIncidentsList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("DisasterIncidentsView", $parm);
        } else {
            $url = $this->keyUrl("DisasterIncidentsView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "DisasterIncidentsAdd?" . $parm;
        } else {
            $url = "DisasterIncidentsAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DisasterIncidentsEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DisasterIncidentsList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DisasterIncidentsAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DisasterIncidentsList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("DisasterIncidentsDelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "DisasterIncidentsList";
    ...
    public function renderListRow()
    {
        ...
        $this->affected_areas->TooltipValue = "";
        ...
        $this->response_actions->TooltipValue = "";

        // lessons_learned
        $this->lessons_learned->HrefValue = "";
        $this->lessons_learned->TooltipValue = "";
    ...
    public function renderEditRow()
    {
        ...
        $this->incident_name->EditValue = $this->incident_name->CurrentValue;
        $this->incident_name->PlaceHolder = RemoveHtml($this->incident_name->caption());

        // occurrence_date
        $this->occurrence_date->setupEditAttributes();
        $this->occurrence_date->EditValue = FormatDateTime($this->occurrence_date->CurrentValue, $this->occurrence_date->formatPattern());
        $this->occurrence_date->PlaceHolder = RemoveHtml($this->occurrence_date->caption());

        // affected_areas
        $this->affected_areas->setupEditAttributes();
        $this->affected_areas->EditValue = $this->affected_areas->CurrentValue;
        ...
        $this->response_actions->EditValue = $this->response_actions->CurrentValue;
        $this->response_actions->PlaceHolder = RemoveHtml($this->response_actions->caption());

        // lessons_learned
        $this->lessons_learned->setupEditAttributes();
        $this->lessons_learned->EditValue = $this->lessons_learned->CurrentValue;
