 ...
 * Page class
 */
class DemographicsDataDelete extends DemographicsData
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DemographicsDataDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "DemographicsDataDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("DemographicsDataList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("DemographicsDataList"); // Return to list
                return;
            }
        }
