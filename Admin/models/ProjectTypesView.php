 ...
 * Page class
 */
class ProjectTypesView extends ProjectTypes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProjectTypesView";
    ...
    // CSS class/style
    public $CurrentPageName = "ProjectTypesView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "ProjectTypesList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ProjectTypesList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
