 ...
 * Page class
 */
class ServiceCategoriesAdd extends ServiceCategories
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ServiceCategoriesAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "ServiceCategoriesAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "ServiceCategoriesView") {
