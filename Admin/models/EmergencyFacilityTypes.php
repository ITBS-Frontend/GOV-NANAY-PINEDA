...
/**
 * Table class for emergency_facility_types
 */
class EmergencyFacilityTypes extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "emergency_facility_types";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // type_name
        $this->type_name = new DbField(
            $this, // Table
            'x_type_name', // Variable name
            'type_name', // Name
            '"type_name"', // Expression
            '"type_name"', // Basic search expression
            200, // Type
            100, // Size
            -1, // Date/Time format
            false, // Is upload field
            '"type_name"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->type_name->InputTextType = "text";
        $this->type_name->Nullable = false; // NOT NULL field
        $this->type_name->Required = true; // Required field
        $this->type_name->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
        ...
        $this->is_active->Lookup = new Lookup($this->is_active, 'emergency_facility_types', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "emergency_facility_types";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("EmergencyFacilityTypesList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "EmergencyFacilityTypesView" => $Language->phrase("View"),
            "EmergencyFacilityTypesEdit" => $Language->phrase("Edit"),
            "EmergencyFacilityTypesAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    {
        return "EmergencyFacilityTypesList";
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "EmergencyFacilityTypesView",
            Config("API_ADD_ACTION") => "EmergencyFacilityTypesAdd",
            Config("API_EDIT_ACTION") => "EmergencyFacilityTypesEdit",
            Config("API_DELETE_ACTION") => "EmergencyFacilityTypesDelete",
            Config("API_LIST_ACTION") => "EmergencyFacilityTypesList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("EmergencyFacilityTypesView", $parm);
        } else {
            $url = $this->keyUrl("EmergencyFacilityTypesView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "EmergencyFacilityTypesAdd?" . $parm;
        } else {
            $url = "EmergencyFacilityTypesAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("EmergencyFacilityTypesEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("EmergencyFacilityTypesList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("EmergencyFacilityTypesAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("EmergencyFacilityTypesList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("EmergencyFacilityTypesDelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "EmergencyFacilityTypesList";
    ...
    public function renderEditRow()
    {
        ...
        // type_name
        $this->type_name->setupEditAttributes();
        if (!$this->type_name->Raw) {
            $this->type_name->CurrentValue = HtmlDecode($this->type_name->CurrentValue);
        }
        $this->type_name->EditValue = $this->type_name->CurrentValue;
        $this->type_name->PlaceHolder = RemoveHtml($this->type_name->caption());
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->type_name);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->type_name);
