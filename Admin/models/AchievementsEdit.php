 ...
 * Page class
 */
class AchievementsEdit extends Achievements
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AchievementsEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "AchievementsEdit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("AchievementsList"); // No matching record, return to list
                        return;
                    }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "AchievementsList") {
                ...
                if ($this->editRow()) { // Update record based on key
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "AchievementsList") {
                            ...
                            $returnUrl = "AchievementsList"; // Return list page content
                        }
                    }
                    if (IsJsonResponse()) {
                        $this->terminate(true);
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("AchievementsList"), "", $this->TableVar, true);
        $pageId = "edit";
