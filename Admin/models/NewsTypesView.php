 ...
 * Page class
 */
class NewsTypesView extends NewsTypes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NewsTypesView";
    ...
    // CSS class/style
    public $CurrentPageName = "NewsTypesView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "NewsTypesList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "NewsTypesList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
