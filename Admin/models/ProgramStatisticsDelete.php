 ...
 * Page class
 */
class ProgramStatisticsDelete extends ProgramStatistics
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProgramStatisticsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ProgramStatisticsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ProgramStatisticsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ProgramStatisticsList"); // Return to list
                return;
            }
        }
