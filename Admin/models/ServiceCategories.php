...
/**
 * Table class for service_categories
 */
class ServiceCategories extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "service_categories";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "service_categories";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ServiceCategoriesList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "ServiceCategoriesView" => $Language->phrase("View"),
            "ServiceCategoriesEdit" => $Language->phrase("Edit"),
            "ServiceCategoriesAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ServiceCategoriesView",
            Config("API_ADD_ACTION") => "ServiceCategoriesAdd",
            Config("API_EDIT_ACTION") => "ServiceCategoriesEdit",
            Config("API_DELETE_ACTION") => "ServiceCategoriesDelete",
            Config("API_LIST_ACTION") => "ServiceCategoriesList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ServiceCategoriesView", $parm);
        } else {
            $url = $this->keyUrl("ServiceCategoriesView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "ServiceCategoriesAdd?" . $parm;
        } else {
            $url = "ServiceCategoriesAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ServiceCategoriesEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ServiceCategoriesList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ServiceCategoriesAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ServiceCategoriesList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ServiceCategoriesDelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "ServiceCategoriesList";
