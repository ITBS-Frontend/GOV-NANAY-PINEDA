 ...
 * Page class
 */
class EnvironmentalProgramsAdd extends EnvironmentalPrograms
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EnvironmentalProgramsAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "EnvironmentalProgramsAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "EnvironmentalProgramsView") {
