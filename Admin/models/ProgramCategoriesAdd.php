 ...
 * Page class
 */
class ProgramCategoriesAdd extends ProgramCategories
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProgramCategoriesAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "ProgramCategoriesAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "ProgramCategoriesView") {
