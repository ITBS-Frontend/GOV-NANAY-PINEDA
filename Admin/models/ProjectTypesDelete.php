 ...
 * Page class
 */
class ProjectTypesDelete extends ProjectTypes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProjectTypesDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ProjectTypesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ProjectTypesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ProjectTypesList"); // Return to list
                return;
            }
        }
