 ...
 * Page class
 */
class ProgramStatisticsView extends ProgramStatistics
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProgramStatisticsView";
    ...
    // CSS class/style
    public $CurrentPageName = "ProgramStatisticsView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "ProgramStatisticsList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ProgramStatisticsList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
