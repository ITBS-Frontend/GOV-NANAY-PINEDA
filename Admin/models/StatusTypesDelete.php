 ...
 * Page class
 */
class StatusTypesDelete extends StatusTypes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "StatusTypesDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "StatusTypesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("StatusTypesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("StatusTypesList"); // Return to list
                return;
            }
        }
