 ...
 * Page class
 */
class DisasterTypesAdd extends DisasterTypes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DisasterTypesAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "DisasterTypesAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "DisasterTypesView") {
