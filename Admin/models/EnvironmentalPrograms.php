...
/**
 * Table class for environmental_programs
 */
class EnvironmentalPrograms extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "environmental_programs";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "environmental_programs";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("EnvironmentalProgramsList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "EnvironmentalProgramsView" => $Language->phrase("View"),
            "EnvironmentalProgramsEdit" => $Language->phrase("Edit"),
            "EnvironmentalProgramsAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    {
        return "EnvironmentalProgramsList";
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "EnvironmentalProgramsView",
            Config("API_ADD_ACTION") => "EnvironmentalProgramsAdd",
            Config("API_EDIT_ACTION") => "EnvironmentalProgramsEdit",
            Config("API_DELETE_ACTION") => "EnvironmentalProgramsDelete",
            Config("API_LIST_ACTION") => "EnvironmentalProgramsList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("EnvironmentalProgramsView", $parm);
        } else {
            $url = $this->keyUrl("EnvironmentalProgramsView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "EnvironmentalProgramsAdd?" . $parm;
        } else {
            $url = "EnvironmentalProgramsAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("EnvironmentalProgramsEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("EnvironmentalProgramsList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("EnvironmentalProgramsAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("EnvironmentalProgramsList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("EnvironmentalProgramsDelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "EnvironmentalProgramsList";
