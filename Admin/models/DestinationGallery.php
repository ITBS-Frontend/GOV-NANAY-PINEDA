...
/**
 * Table class for destination_gallery
 */
class DestinationGallery extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = "destination_gallery";
        $this->TableName = 'destination_gallery';
        $this->TableType = "TABLE";
        $this->ImportUseTransaction = $this->supportsTransaction() && Config("IMPORT_USE_TRANSACTION");
        $this->UseTransaction = $this->supportsTransaction() && Config("USE_TRANSACTION");

        // Update Table
        $this->UpdateTable = "destination_gallery";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // destination_id
        $this->destination_id = new DbField(
            $this, // Table
            'x_destination_id', // Variable name
            'destination_id', // Name
            '"destination_id"', // Expression
            'CAST("destination_id" AS varchar(255))', // Basic search expression
            3, // Type
            0, // Size
            -1, // Date/Time format
            false, // Is upload field
            '"destination_id"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->destination_id->Lookup = new Lookup($this->destination_id, 'tourism_destinations', false, 'id', ["name","","",""], '', '', [], [], [], [], [], [], false, '', '', "\"name\"");
        $this->destination_id->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->destination_id->SearchOperators = ["=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "destination_gallery";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("DestinationGalleryList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "DestinationGalleryView" => $Language->phrase("View"),
            "DestinationGalleryEdit" => $Language->phrase("Edit"),
            "DestinationGalleryAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "DestinationGalleryView",
            Config("API_ADD_ACTION") => "DestinationGalleryAdd",
            Config("API_EDIT_ACTION") => "DestinationGalleryEdit",
            Config("API_DELETE_ACTION") => "DestinationGalleryDelete",
            Config("API_LIST_ACTION") => "DestinationGalleryList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("DestinationGalleryView", $parm);
        } else {
            $url = $this->keyUrl("DestinationGalleryView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "DestinationGalleryAdd?" . $parm;
        } else {
            $url = "DestinationGalleryAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DestinationGalleryEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DestinationGalleryList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DestinationGalleryAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DestinationGalleryList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("DestinationGalleryDelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "DestinationGalleryList";
    ...
    public function renderListRow()
    {
        ...
        if ($this->image_path->UseColorbox) {
            ...
            $this->image_path->LinkAttrs["data-rel"] = "destination_gallery_x_image_path";
