 ...
 * Page class
 */
class DisasterPreparednessView extends DisasterPreparedness
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DisasterPreparednessView";
    ...
    // CSS class/style
    public $CurrentPageName = "DisasterPreparednessView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "DisasterPreparednessList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "DisasterPreparednessList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
