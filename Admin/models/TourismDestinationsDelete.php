 ...
 * Page class
 */
class TourismDestinationsDelete extends TourismDestinations
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TourismDestinationsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "TourismDestinationsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("TourismDestinationsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("TourismDestinationsList"); // Return to list
                return;
            }
        }
