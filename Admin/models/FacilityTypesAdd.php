 ...
 * Page class
 */
class FacilityTypesAdd extends FacilityTypes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FacilityTypesAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "FacilityTypesAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "FacilityTypesView") {
