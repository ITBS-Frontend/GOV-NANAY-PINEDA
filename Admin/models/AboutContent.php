...
/**
 * Table class for about_content
 */
class AboutContent extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "about_content";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // section_type
        $this->section_type = new DbField(
            $this, // Table
            'x_section_type', // Variable name
            'section_type', // Name
            '"section_type"', // Expression
            '"section_type"', // Basic search expression
            200, // Type
            50, // Size
            -1, // Date/Time format
            false, // Is upload field
            '"section_type"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->section_type->InputTextType = "text";
        $this->section_type->Nullable = false; // NOT NULL field
        $this->section_type->Required = true; // Required field
        $this->section_type->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
        $this->Fields['section_type'] = &$this->section_type;
        ...
        $this->is_active->Lookup = new Lookup($this->is_active, 'about_content', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "about_content";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->section_type->DbValue = $row['section_type'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("AboutContentList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "AboutContentView" => $Language->phrase("View"),
            "AboutContentEdit" => $Language->phrase("Edit"),
            "AboutContentAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "AboutContentView",
            Config("API_ADD_ACTION") => "AboutContentAdd",
            Config("API_EDIT_ACTION") => "AboutContentEdit",
            Config("API_DELETE_ACTION") => "AboutContentDelete",
            Config("API_LIST_ACTION") => "AboutContentList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("AboutContentView", $parm);
        } else {
            $url = $this->keyUrl("AboutContentView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("AboutContentEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("AboutContentList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("AboutContentAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("AboutContentList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("AboutContentDelete", $parm);
        }
    }
    ...
    public function renderEditRow()
    {
        ...
        $this->section_type->EditValue = $this->section_type->CurrentValue;
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->section_type);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->section_type);
