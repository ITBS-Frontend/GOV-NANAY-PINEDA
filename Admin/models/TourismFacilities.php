...
/**
 * Table class for tourism_facilities
 */
class TourismFacilities extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = "tourism_facilities";
        $this->TableName = 'tourism_facilities';
        $this->TableType = "TABLE";
        $this->ImportUseTransaction = $this->supportsTransaction() && Config("IMPORT_USE_TRANSACTION");
        $this->UseTransaction = $this->supportsTransaction() && Config("USE_TRANSACTION");

        // Update Table
        $this->UpdateTable = "tourism_facilities";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->municipality->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        ...
        // contact_number
        $this->contact_number = new DbField(
            $this, // Table
            'x_contact_number', // Variable name
            'contact_number', // Name
            '"contact_number"', // Expression
            '"contact_number"', // Basic search expression
            200, // Type
            50, // Size
            -1, // Date/Time format
            false, // Is upload field
            '"contact_number"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->contact_number->InputTextType = "text";
        $this->contact_number->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        ...
        // price_range
        $this->price_range = new DbField(
            $this, // Table
            'x_price_range', // Variable name
            'price_range', // Name
            '"price_range"', // Expression
            '"price_range"', // Basic search expression
            200, // Type
            100, // Size
            -1, // Date/Time format
            false, // Is upload field
            '"price_range"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->price_range->InputTextType = "text";
        $this->price_range->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['price_range'] = &$this->price_range;

        // amenities
        $this->amenities = new DbField(
            $this, // Table
            'x_amenities', // Variable name
            'amenities', // Name
            '"amenities"', // Expression
            '"amenities"', // Basic search expression
            201, // Type
            0, // Size
            -1, // Date/Time format
            false, // Is upload field
            '"amenities"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->amenities->InputTextType = "text";
        $this->amenities->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        ...
        $this->rating = new DbField(
            ...
            'rating', // Name
            '"rating"', // Expression
            'CAST("rating" AS varchar(255))', // Basic search expression
            14, // Type
            0, // Size
            -1, // Date/Time format
            false, // Is upload field
        ...
        $this->rating->addMethod("getDefault", fn() => 0);
        $this->rating->InputTextType = "text";
        $this->rating->Raw = true;
        $this->rating->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->rating->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        ...
        $this->is_verified = new DbField(
            ...
            'CAST("is_verified" AS varchar(255))', // Basic search expression
            11, // Type
            0, // Size
            -1, // Date/Time format
            false, // Is upload field
        ...
        $this->is_verified->Lookup = new Lookup($this->is_verified, 'tourism_facilities', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        $this->is_verified->OptionCount = 2;
        $this->is_verified->SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"];
        ...
        $this->is_active->Lookup = new Lookup($this->is_active, 'tourism_facilities', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->facility_type_id->Lookup = new Lookup($this->facility_type_id, 'tourism_facility_types', false, 'id', ["type_name","","",""], '', '', [], [], [], [], [], [], false, '', '', "\"type_name\"");
        ...
        // ownership_type_id
        $this->ownership_type_id = new DbField(
            $this, // Table
            'x_ownership_type_id', // Variable name
            'ownership_type_id', // Name
            '"ownership_type_id"', // Expression
            'CAST("ownership_type_id" AS varchar(255))', // Basic search expression
            3, // Type
            0, // Size
            -1, // Date/Time format
            false, // Is upload field
            '"ownership_type_id"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->ownership_type_id->InputTextType = "text";
        $this->ownership_type_id->Raw = true;
        $this->ownership_type_id->setSelectMultiple(false); // Select one
        $this->ownership_type_id->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->ownership_type_id->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        $this->ownership_type_id->Lookup = new Lookup($this->ownership_type_id, 'ownership_types', false, 'id', ["type_name","","",""], '', '', [], [], [], [], [], [], false, '', '', "\"type_name\"");
        $this->ownership_type_id->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->ownership_type_id->SearchOperators = ["=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        $this->Fields['ownership_type_id'] = &$this->ownership_type_id;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "tourism_facilities";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->contact_number->DbValue = $row['contact_number'];
        ...
        $this->ownership_type_id->DbValue = $row['ownership_type_id'];
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("TourismFacilitiesList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "TourismFacilitiesView" => $Language->phrase("View"),
            "TourismFacilitiesEdit" => $Language->phrase("Edit"),
            "TourismFacilitiesAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "TourismFacilitiesView",
            Config("API_ADD_ACTION") => "TourismFacilitiesAdd",
            Config("API_EDIT_ACTION") => "TourismFacilitiesEdit",
            Config("API_DELETE_ACTION") => "TourismFacilitiesDelete",
            Config("API_LIST_ACTION") => "TourismFacilitiesList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("TourismFacilitiesView", $parm);
        } else {
            $url = $this->keyUrl("TourismFacilitiesView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "TourismFacilitiesAdd?" . $parm;
        } else {
            $url = "TourismFacilitiesAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TourismFacilitiesEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TourismFacilitiesList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TourismFacilitiesAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TourismFacilitiesList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("TourismFacilitiesDelete", $parm);
        }
    }
    ...
    public function loadListRowValues(&$rs)
    {
        ...
        $this->price_range->setDbValue($row['price_range']);
        $this->amenities->setDbValue($row['amenities']);
    ...
    {
        global $Response;
        $listPage = "TourismFacilitiesList";
    ...
    public function renderListRow()
    {
        ...
        if ($this->featured_image->UseColorbox) {
            ...
            $this->featured_image->LinkAttrs["data-rel"] = "tourism_facilities_x_featured_image";
    ...
    public function renderEditRow()
    {
        ...
        $this->contact_number->EditValue = $this->contact_number->CurrentValue;
        ...
        // price_range
        $this->price_range->setupEditAttributes();
        if (!$this->price_range->Raw) {
            $this->price_range->CurrentValue = HtmlDecode($this->price_range->CurrentValue);
        }
        $this->price_range->EditValue = $this->price_range->CurrentValue;
        $this->price_range->PlaceHolder = RemoveHtml($this->price_range->caption());

        // amenities
        $this->amenities->setupEditAttributes();
        $this->amenities->EditValue = $this->amenities->CurrentValue;
        $this->amenities->PlaceHolder = RemoveHtml($this->amenities->caption());
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->contact_number);
                    $doc->exportCaption($this->_email);
                    $doc->exportCaption($this->website);
                    $doc->exportCaption($this->price_range);
                    $doc->exportCaption($this->amenities);
                    ...
                    $doc->exportCaption($this->ownership_type_id);
                } else {
                    $doc->exportCaption($this->id);
                    $doc->exportCaption($this->name);
                    $doc->exportCaption($this->municipality);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->contact_number);
                        $doc->exportField($this->_email);
                        $doc->exportField($this->website);
                        $doc->exportField($this->price_range);
                        $doc->exportField($this->amenities);
                        ...
                        $doc->exportField($this->ownership_type_id);
                    } else {
                        $doc->exportField($this->id);
                        $doc->exportField($this->name);
                        $doc->exportField($this->municipality);
