 ...
 * Page class
 */
class TourismActivitiesDelete extends TourismActivities
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TourismActivitiesDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "TourismActivitiesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("TourismActivitiesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("TourismActivitiesList"); // Return to list
                return;
            }
        }
