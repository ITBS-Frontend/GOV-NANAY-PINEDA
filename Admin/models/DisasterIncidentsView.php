 ...
 * Page class
 */
class DisasterIncidentsView extends DisasterIncidents
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DisasterIncidentsView";
    ...
    // CSS class/style
    public $CurrentPageName = "DisasterIncidentsView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "DisasterIncidentsList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "DisasterIncidentsList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
