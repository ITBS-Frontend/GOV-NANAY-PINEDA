 ...
 * Page class
 */
class AboutContentView extends AboutContent
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AboutContentView";
    ...
    // CSS class/style
    public $CurrentPageName = "AboutContentView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "AboutContentList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "AboutContentList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
