 ...
 * Page class
 */
class StatusTypesView extends StatusTypes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "StatusTypesView";
    ...
    // CSS class/style
    public $CurrentPageName = "StatusTypesView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "StatusTypesList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "StatusTypesList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
