...
/**
 * Table class for news_tags
 */
class NewsTags extends DbTable
{
    protected $SqlFrom = "";
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "news_tags";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("NewsTagsList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "NewsTagsView" => $Language->phrase("View"),
            "NewsTagsEdit" => $Language->phrase("Edit"),
            "NewsTagsAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "NewsTagsView",
            Config("API_ADD_ACTION") => "NewsTagsAdd",
            Config("API_EDIT_ACTION") => "NewsTagsEdit",
            Config("API_DELETE_ACTION") => "NewsTagsDelete",
            Config("API_LIST_ACTION") => "NewsTagsList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("NewsTagsView", $parm);
        } else {
            $url = $this->keyUrl("NewsTagsView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("NewsTagsEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("NewsTagsList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("NewsTagsAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("NewsTagsList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("NewsTagsDelete", $parm);
        }
    }
