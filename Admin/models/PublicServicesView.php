 ...
 * Page class
 */
class PublicServicesView extends PublicServices
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PublicServicesView";
    ...
    // CSS class/style
    public $CurrentPageName = "PublicServicesView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "PublicServicesList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "PublicServicesList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
