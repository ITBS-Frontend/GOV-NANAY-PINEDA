 ...
 * Page class
 */
class ProfileImagesDelete extends ProfileImages
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProfileImagesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ProfileImagesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ProfileImagesList"); // Return to list
                return;
            }
        }
