 ...
 * Page class
 */
class DemographicsTypesView extends DemographicsTypes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DemographicsTypesView";
    ...
    // CSS class/style
    public $CurrentPageName = "DemographicsTypesView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "DemographicsTypesList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "DemographicsTypesList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
