 ...
 * Page class
 */
class TourismFacilityTypesView extends TourismFacilityTypes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TourismFacilityTypesView";
    ...
    // CSS class/style
    public $CurrentPageName = "TourismFacilityTypesView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "TourismFacilityTypesList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "TourismFacilityTypesList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
