 ...
 * Page class
 */
class EmergencyFacilityTypesDelete extends EmergencyFacilityTypes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmergencyFacilityTypesDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "EmergencyFacilityTypesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("EmergencyFacilityTypesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("EmergencyFacilityTypesList"); // Return to list
                return;
            }
        }
