 ...
 * Page class
 */
class UserPermissionsAdd extends UserPermissions
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "UserPermissionsAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "UserPermissionsAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("UserPermissionsList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "UserPermissionsList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "UserPermissionsView") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "UserPermissionsList") {
                            ...
                            $returnUrl = "UserPermissionsList"; // Return list page content
                        }
                    }
    ...
    {
        $this->_permission->DefaultValue = $this->_permission->getDefault(); // PHP
        $this->_permission->OldValue = $this->_permission->DefaultValue;
    }
    ...
    public function renderRow()
    {
        ...
        // permission_id
        $this->permission_id->RowCssClass = "row";
    ...
    protected function validateForm()
    {
        ...
        $validateForm = true;
            ...
            if ($this->table_name->Visible && $this->table_name->Required) {
    ...
    protected function getAddRow()
    {
        ...
        // permission
        $this->_permission->setDbValueDef($rsnew, $this->_permission->CurrentValue, strval($this->_permission->CurrentValue) == "");
    ...
    protected function restoreAddFormFromRow($row)
    {
        ...
        if (isset($row['table_name'])) { // table_name
            $this->table_name->setFormValue($row['table_name']);
        }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("UserPermissionsList"), "", $this->TableVar, true);
