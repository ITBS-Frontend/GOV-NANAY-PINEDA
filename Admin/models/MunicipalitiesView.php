 ...
 * Page class
 */
class MunicipalitiesView extends Municipalities
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MunicipalitiesView";
    ...
    // CSS class/style
    public $CurrentPageName = "MunicipalitiesView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "MunicipalitiesList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "MunicipalitiesList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
