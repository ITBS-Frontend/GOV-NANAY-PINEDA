 ...
 * Page class
 */
class OwnershipTypesAdd extends OwnershipTypes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "OwnershipTypesAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "OwnershipTypesAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("OwnershipTypesList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "OwnershipTypesList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "OwnershipTypesView") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "OwnershipTypesList") {
                            ...
                            $returnUrl = "OwnershipTypesList"; // Return list page content
                        }
                    }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("OwnershipTypesList"), "", $this->TableVar, true);
