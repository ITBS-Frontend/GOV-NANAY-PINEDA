 ...
 * Page class
 */
class TourismFacilitiesView extends TourismFacilities
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TourismFacilitiesView";
    ...
    // CSS class/style
    public $CurrentPageName = "TourismFacilitiesView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "TourismFacilitiesList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "TourismFacilitiesList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
