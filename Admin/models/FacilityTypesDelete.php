 ...
 * Page class
 */
class FacilityTypesDelete extends FacilityTypes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FacilityTypesDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "FacilityTypesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("FacilityTypesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("FacilityTypesList"); // Return to list
                return;
            }
        }
