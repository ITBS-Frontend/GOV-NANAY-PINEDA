...
/**
 * Table class for difficulty_levels
 */
class DifficultyLevels extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "difficulty_levels";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // level_name
        $this->level_name = new DbField(
            $this, // Table
            'x_level_name', // Variable name
            'level_name', // Name
            '"level_name"', // Expression
            '"level_name"', // Basic search expression
            200, // Type
            50, // Size
            -1, // Date/Time format
            false, // Is upload field
            '"level_name"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->level_name->InputTextType = "text";
        $this->level_name->Nullable = false; // NOT NULL field
        $this->level_name->Required = true; // Required field
        $this->level_name->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
        ...
        $this->is_active->Lookup = new Lookup($this->is_active, 'difficulty_levels', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "difficulty_levels";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->level_name->DbValue = $row['level_name'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("DifficultyLevelsList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "DifficultyLevelsView" => $Language->phrase("View"),
            "DifficultyLevelsEdit" => $Language->phrase("Edit"),
            "DifficultyLevelsAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "DifficultyLevelsView",
            Config("API_ADD_ACTION") => "DifficultyLevelsAdd",
            Config("API_EDIT_ACTION") => "DifficultyLevelsEdit",
            Config("API_DELETE_ACTION") => "DifficultyLevelsDelete",
            Config("API_LIST_ACTION") => "DifficultyLevelsList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("DifficultyLevelsView", $parm);
        } else {
            $url = $this->keyUrl("DifficultyLevelsView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "DifficultyLevelsAdd?" . $parm;
        } else {
            $url = "DifficultyLevelsAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DifficultyLevelsEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DifficultyLevelsList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DifficultyLevelsAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DifficultyLevelsList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("DifficultyLevelsDelete", $parm);
        }
    }
    ...
    public function renderEditRow()
    {
        ...
        $this->level_name->EditValue = $this->level_name->CurrentValue;
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->level_name);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->level_name);
