 ...
 * Page class
 */
class DifficultyLevelsAdd extends DifficultyLevels
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DifficultyLevelsAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "DifficultyLevelsAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "DifficultyLevelsView") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->level_name->CurrentValue != "") { // Check field with unique index
            $filter = "(\"level_name\" = '" . AdjustSql($this->level_name->CurrentValue, $this->Dbid) . "')";
    ...
    protected function restoreAddFormFromRow($row)
    {
        if (isset($row['level_name'])) { // level_name
            $this->level_name->setFormValue($row['level_name']);
        }
