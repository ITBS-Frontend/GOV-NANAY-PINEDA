 ...
 * Page class
 */
class GeographicInfoView extends GeographicInfo
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "GeographicInfoView";
    ...
    // CSS class/style
    public $CurrentPageName = "GeographicInfoView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "GeographicInfoList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "GeographicInfoList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
