 ...
 * Page class
 */
class ProfileImagesView extends ProfileImages
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProfileImagesView";
    ...
    // CSS class/style
    public $CurrentPageName = "ProfileImagesView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "ProfileImagesList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ProfileImagesList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
