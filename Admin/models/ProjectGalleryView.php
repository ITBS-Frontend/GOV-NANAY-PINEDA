 ...
 * Page class
 */
class ProjectGalleryView extends ProjectGallery
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProjectGalleryView";
    ...
    // CSS class/style
    public $CurrentPageName = "ProjectGalleryView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "ProjectGalleryList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ProjectGalleryList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
